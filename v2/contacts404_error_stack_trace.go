...
type Contacts404Error_stackTrace struct {
...
// NewContacts404Error_stackTrace instantiates a new Contacts404Error_stackTrace and sets the default values.
func NewContacts404Error_stackTrace() *Contacts404Error_stackTrace {
	m := &Contacts404Error_stackTrace{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateContacts404Error_stackTraceFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateContacts404Error_stackTraceFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewContacts404Error_stackTrace(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *Contacts404Error_stackTrace) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetClassLoaderName gets the classLoaderName property value. The classLoaderName property
// returns a *string when successful
func (m *Contacts404Error_stackTrace) GetClassLoaderName() *string {
	return m.classLoaderName
}

// GetClassName gets the className property value. The className property
// returns a *string when successful
func (m *Contacts404Error_stackTrace) GetClassName() *string {
	return m.className
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *Contacts404Error_stackTrace) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *Contacts404Error_stackTrace) GetFileName() *string {
	return m.fileName
}

// GetLineNumber gets the lineNumber property value. The lineNumber property
// returns a *int32 when successful
func (m *Contacts404Error_stackTrace) GetLineNumber() *int32 {
	return m.lineNumber
}

// GetMethodName gets the methodName property value. The methodName property
// returns a *string when successful
func (m *Contacts404Error_stackTrace) GetMethodName() *string {
	return m.methodName
}

// GetModuleName gets the moduleName property value. The moduleName property
// returns a *string when successful
func (m *Contacts404Error_stackTrace) GetModuleName() *string {
	return m.moduleName
}

// GetModuleVersion gets the moduleVersion property value. The moduleVersion property
// returns a *string when successful
func (m *Contacts404Error_stackTrace) GetModuleVersion() *string {
	return m.moduleVersion
}

// GetNativeMethod gets the nativeMethod property value. The nativeMethod property
// returns a *bool when successful
func (m *Contacts404Error_stackTrace) GetNativeMethod() *bool {
	return m.nativeMethod
}

// Serialize serializes information the current object
func (m *Contacts404Error_stackTrace) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
