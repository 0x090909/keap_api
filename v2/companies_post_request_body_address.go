...
type CompaniesPostRequestBody_address struct {
...
// NewCompaniesPostRequestBody_address instantiates a new CompaniesPostRequestBody_address and sets the default values.
func NewCompaniesPostRequestBody_address() *CompaniesPostRequestBody_address {
	m := &CompaniesPostRequestBody_address{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateCompaniesPostRequestBody_addressFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateCompaniesPostRequestBody_addressFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewCompaniesPostRequestBody_address(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *CompaniesPostRequestBody_address) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCountry gets the country property value. The long-name descriptive version of the Country Code
// returns a *string when successful
func (m *CompaniesPostRequestBody_address) GetCountry() *string {
	return m.country
}
...
// returns a *string when successful
func (m *CompaniesPostRequestBody_address) GetCountryCode() *string {
	return m.country_code
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *CompaniesPostRequestBody_address) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *CompaniesPostRequestBody_address) GetRegionCode() *string {
	return m.region_code
}

// GetZipCode gets the zip_code property value. The zip_code property
// returns a *string when successful
func (m *CompaniesPostRequestBody_address) GetZipCode() *string {
	return m.zip_code
}

// GetZipFour gets the zip_four property value. The zip_four property
// returns a *string when successful
func (m *CompaniesPostRequestBody_address) GetZipFour() *string {
	return m.zip_four
}

// Serialize serializes information the current object
func (m *CompaniesPostRequestBody_address) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *CompaniesPostRequestBody_address) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCountry sets the country property value. The long-name descriptive version of the Country Code
func (m *CompaniesPostRequestBody_address) SetCountry(value *string) {
	m.country = value
}
...
func (m *CompaniesPostRequestBody_address) SetRegionCode(value *string) {
	m.region_code = value
}

// SetZipCode sets the zip_code property value. The zip_code property
func (m *CompaniesPostRequestBody_address) SetZipCode(value *string) {
	m.zip_code = value
}

// SetZipFour sets the zip_four property value. The zip_four property
func (m *CompaniesPostRequestBody_address) SetZipFour(value *string) {
	m.zip_four = value
}

type CompaniesPostRequestBody_addressable interface {
