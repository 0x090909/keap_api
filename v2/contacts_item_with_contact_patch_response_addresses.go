...
type ContactsItemWithContact_PatchResponse_addresses struct {
...
// NewContactsItemWithContact_PatchResponse_addresses instantiates a new ContactsItemWithContact_PatchResponse_addresses and sets the default values.
func NewContactsItemWithContact_PatchResponse_addresses() *ContactsItemWithContact_PatchResponse_addresses {
	m := &ContactsItemWithContact_PatchResponse_addresses{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateContactsItemWithContact_PatchResponse_addressesFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateContactsItemWithContact_PatchResponse_addressesFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewContactsItemWithContact_PatchResponse_addresses(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCountry gets the country property value. The long-name descriptive version of the Country Code
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetCountry() *string {
	return m.country
}
...
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetCountryCode() *string {
	return m.country_code
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetLine1() *string {
	return m.line1
}

// GetLine2 gets the line2 property value. The line2 property
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetLine2() *string {
	return m.line2
}

// GetLocality gets the locality property value. The municipality to which the address belongs
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetLocality() *string {
	return m.locality
}

// GetPostalCode gets the postal_code property value. The postal_code property
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetPostalCode() *string {
	return m.postal_code
}

// GetRegion gets the region property value. The long-name descriptive version of the Region Code
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetRegion() *string {
	return m.region
}
...
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetRegionCode() *string {
	return m.region_code
}

// GetZipCode gets the zip_code property value. The zip_code property
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetZipCode() *string {
	return m.zip_code
}

// GetZipFour gets the zip_four property value. The zip_four property
// returns a *string when successful
func (m *ContactsItemWithContact_PatchResponse_addresses) GetZipFour() *string {
	return m.zip_four
}

// Serialize serializes information the current object
func (m *ContactsItemWithContact_PatchResponse_addresses) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ContactsItemWithContact_PatchResponse_addresses) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCountry sets the country property value. The long-name descriptive version of the Country Code
func (m *ContactsItemWithContact_PatchResponse_addresses) SetCountry(value *string) {
	m.country = value
}
...
func (m *ContactsItemWithContact_PatchResponse_addresses) SetCountryCode(value *string) {
	m.country_code = value
}

// SetLine1 sets the line1 property value. The line1 property
func (m *ContactsItemWithContact_PatchResponse_addresses) SetLine1(value *string) {
	m.line1 = value
}

// SetLine2 sets the line2 property value. The line2 property
func (m *ContactsItemWithContact_PatchResponse_addresses) SetLine2(value *string) {
	m.line2 = value
}

// SetLocality sets the locality property value. The municipality to which the address belongs
func (m *ContactsItemWithContact_PatchResponse_addresses) SetLocality(value *string) {
	m.locality = value
}

// SetPostalCode sets the postal_code property value. The postal_code property
func (m *ContactsItemWithContact_PatchResponse_addresses) SetPostalCode(value *string) {
	m.postal_code = value
}

// SetRegion sets the region property value. The long-name descriptive version of the Region Code
func (m *ContactsItemWithContact_PatchResponse_addresses) SetRegion(value *string) {
	m.region = value
}
...
func (m *ContactsItemWithContact_PatchResponse_addresses) SetRegionCode(value *string) {
	m.region_code = value
}

// SetZipCode sets the zip_code property value. The zip_code property
func (m *ContactsItemWithContact_PatchResponse_addresses) SetZipCode(value *string) {
	m.zip_code = value
}

// SetZipFour sets the zip_four property value. The zip_four property
func (m *ContactsItemWithContact_PatchResponse_addresses) SetZipFour(value *string) {
	m.zip_four = value
}

type ContactsItemWithContact_PatchResponse_addressesable interface {
