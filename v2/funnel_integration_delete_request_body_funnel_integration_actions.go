...
type FunnelIntegrationDeleteRequestBody_funnel_integration_actions struct {
...
// NewFunnelIntegrationDeleteRequestBody_funnel_integration_actions instantiates a new FunnelIntegrationDeleteRequestBody_funnel_integration_actions and sets the default values.
func NewFunnelIntegrationDeleteRequestBody_funnel_integration_actions() *FunnelIntegrationDeleteRequestBody_funnel_integration_actions {
	m := &FunnelIntegrationDeleteRequestBody_funnel_integration_actions{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateFunnelIntegrationDeleteRequestBody_funnel_integration_actionsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateFunnelIntegrationDeleteRequestBody_funnel_integration_actionsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewFunnelIntegrationDeleteRequestBody_funnel_integration_actions(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetAdditionalData() map[string]any {
...
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetBaseUrl() *string {
	return m.base_url
}
...
// returns a *string when successful
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetContext() *string {
	return m.context
}

// GetEnabled gets the enabled property value. The flag to enable or disable the integration trigger.
// returns a *bool when successful
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetEnabled() *bool {
	return m.enabled
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetFunnelSchemaJson() *string {
...
// returns a *string when successful
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetIconUrl() *string {
	return m.icon_url
}
...
// returns a *string when successful
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) GetName() *string {
	return m.name
}

// Serialize serializes information the current object
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) SetAdditionalData(value map[string]any) {
...
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) SetBaseUrl(value *string) {
	m.base_url = value
}
...
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) SetContext(value *string) {
	m.context = value
}

// SetEnabled sets the enabled property value. The flag to enable or disable the integration trigger.
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) SetEnabled(value *bool) {
	m.enabled = value
}
...
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) SetFunnelSchemaJson(value *string) {
...
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) SetIconUrl(value *string) {
	m.icon_url = value
}
...
func (m *FunnelIntegrationDeleteRequestBody_funnel_integration_actions) SetName(value *string) {
	m.name = value
}

type FunnelIntegrationDeleteRequestBody_funnel_integration_actionsable interface {
