...
type SettingsApplicationsGetConfigurationGetResponse_contact struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// The address_labels property
	address_labels SettingsApplicationsGetConfigurationGetResponse_contact_address_labelsable
...
// NewSettingsApplicationsGetConfigurationGetResponse_contact instantiates a new SettingsApplicationsGetConfigurationGetResponse_contact and sets the default values.
func NewSettingsApplicationsGetConfigurationGetResponse_contact() *SettingsApplicationsGetConfigurationGetResponse_contact {
	m := &SettingsApplicationsGetConfigurationGetResponse_contact{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateSettingsApplicationsGetConfigurationGetResponse_contactFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateSettingsApplicationsGetConfigurationGetResponse_contactFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewSettingsApplicationsGetConfigurationGetResponse_contact(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAddressLabels gets the address_labels property value. The address_labels property
// returns a SettingsApplicationsGetConfigurationGetResponse_contact_address_labelsable when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetAddressLabels() SettingsApplicationsGetConfigurationGetResponse_contact_address_labelsable {
	return m.address_labels
}

// GetContactTypes gets the contact_types property value. The contact_types property
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetContactTypes() *string {
...
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetDefaultNewContactForm() *string {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetDisableContactEditInClientLogin() *bool {
	return m.disable_contact_edit_in_client_login
}

// GetFaxTypes gets the fax_types property value. The fax_types property
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetFaxTypes() *string {
	return m.fax_types
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["address_labels"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateSettingsApplicationsGetConfigurationGetResponse_contact_address_labelsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetAddressLabels(val.(SettingsApplicationsGetConfigurationGetResponse_contact_address_labelsable))
		}
		return nil
	}
...
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetPhoneTypes() *string {
	return m.phone_types
}

// GetSuffixTypes gets the suffix_types property value. The suffix_types property
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetSuffixTypes() *string {
	return m.suffix_types
}

// GetTitleTypes gets the title_types property value. The title_types property
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) GetTitleTypes() *string {
	return m.title_types
}

// Serialize serializes information the current object
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetAddressLabels sets the address_labels property value. The address_labels property
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetAddressLabels(value SettingsApplicationsGetConfigurationGetResponse_contact_address_labelsable) {
	m.address_labels = value
}

// SetContactTypes sets the contact_types property value. The contact_types property
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetContactTypes(value *string) {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetDefaultNewContactForm(value *string) {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetDisableContactEditInClientLogin(value *bool) {
	m.disable_contact_edit_in_client_login = value
}

// SetFaxTypes sets the fax_types property value. The fax_types property
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetFaxTypes(value *string) {
	m.fax_types = value
}

// SetPhoneTypes sets the phone_types property value. The phone_types property
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetPhoneTypes(value *string) {
	m.phone_types = value
}

// SetSuffixTypes sets the suffix_types property value. The suffix_types property
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetSuffixTypes(value *string) {
	m.suffix_types = value
}

// SetTitleTypes sets the title_types property value. The title_types property
func (m *SettingsApplicationsGetConfigurationGetResponse_contact) SetTitleTypes(value *string) {
	m.title_types = value
}

type SettingsApplicationsGetConfigurationGetResponse_contactable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAddressLabels() SettingsApplicationsGetConfigurationGetResponse_contact_address_labelsable
	...
	SetAddressLabels(value SettingsApplicationsGetConfigurationGetResponse_contact_address_labelsable)
