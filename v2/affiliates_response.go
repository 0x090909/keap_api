...
// Deprecated: This class is obsolete. Use AffiliatesPostResponseable instead.
type AffiliatesResponse struct {
	AffiliatesPostResponse
}
...
func NewAffiliatesResponse() *AffiliatesResponse {
	m := &AffiliatesResponse{
		AffiliatesPostResponse: *NewAffiliatesPostResponse(),
	}
	return m
}
