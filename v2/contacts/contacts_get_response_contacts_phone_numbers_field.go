...
const (
	PHONE_NUMBER_FIELD_UNSPECIFIED_CONTACTSGETRESPONSE_CONTACTS_PHONE_NUMBERS_FIELD ContactsGetResponse_contacts_phone_numbers_field = iota
	PHONE1_CONTACTSGETRESPONSE_CONTACTS_PHONE_NUMBERS_FIELD
...
func ParseContactsGetResponse_contacts_phone_numbers_field(v string) (any, error) {
	result := PHONE_NUMBER_FIELD_UNSPECIFIED_CONTACTSGETRESPONSE_CONTACTS_PHONE_NUMBERS_FIELD
	switch v {
