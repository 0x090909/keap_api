...
const (
	ADDRESS_FIELD_UNSPECIFIED_CONTACTSGETRESPONSE_CONTACTS_ADDRESSES_FIELD ContactsGetResponse_contacts_addresses_field = iota
	BILLING_CONTACTSGETRESPONSE_CONTACTS_ADDRESSES_FIELD
...
func ParseContactsGetResponse_contacts_addresses_field(v string) (any, error) {
	result := ADDRESS_FIELD_UNSPECIFIED_CONTACTSGETRESPONSE_CONTACTS_ADDRESSES_FIELD
	switch v {
