...
const (
	FAX_NUMBER_FIELD_UNSPECIFIED_CONTACTSPOSTRESPONSE_FAX_NUMBERS_FIELD ContactsPostResponse_fax_numbers_field = iota
	FAX1_CONTACTSPOSTRESPONSE_FAX_NUMBERS_FIELD
...
func ParseContactsPostResponse_fax_numbers_field(v string) (any, error) {
	result := FAX_NUMBER_FIELD_UNSPECIFIED_CONTACTSPOSTRESPONSE_FAX_NUMBERS_FIELD
	switch v {
