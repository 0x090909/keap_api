...
const (
	EMAIL_FIELD_UNSPECIFIED_CONTACTSGETRESPONSE_CONTACTS_EMAIL_ADDRESSES_FIELD ContactsGetResponse_contacts_email_addresses_field = iota
	EMAIL1_CONTACTSGETRESPONSE_CONTACTS_EMAIL_ADDRESSES_FIELD
...
func ParseContactsGetResponse_contacts_email_addresses_field(v string) (any, error) {
	result := EMAIL_FIELD_UNSPECIFIED_CONTACTSGETRESPONSE_CONTACTS_EMAIL_ADDRESSES_FIELD
	switch v {
