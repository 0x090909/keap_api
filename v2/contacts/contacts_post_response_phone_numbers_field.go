...
const (
	PHONE_NUMBER_FIELD_UNSPECIFIED_CONTACTSPOSTRESPONSE_PHONE_NUMBERS_FIELD ContactsPostResponse_phone_numbers_field = iota
	PHONE1_CONTACTSPOSTRESPONSE_PHONE_NUMBERS_FIELD
...
func ParseContactsPostResponse_phone_numbers_field(v string) (any, error) {
	result := PHONE_NUMBER_FIELD_UNSPECIFIED_CONTACTSPOSTRESPONSE_PHONE_NUMBERS_FIELD
	switch v {
