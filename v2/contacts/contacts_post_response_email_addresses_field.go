...
const (
	EMAIL_FIELD_UNSPECIFIED_CONTACTSPOSTRESPONSE_EMAIL_ADDRESSES_FIELD ContactsPostResponse_email_addresses_field = iota
	EMAIL1_CONTACTSPOSTRESPONSE_EMAIL_ADDRESSES_FIELD
...
func ParseContactsPostResponse_email_addresses_field(v string) (any, error) {
	result := EMAIL_FIELD_UNSPECIFIED_CONTACTSPOSTRESPONSE_EMAIL_ADDRESSES_FIELD
	switch v {
