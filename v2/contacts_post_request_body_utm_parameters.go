...
type ContactsPostRequestBody_utm_parameters struct {
...
// NewContactsPostRequestBody_utm_parameters instantiates a new ContactsPostRequestBody_utm_parameters and sets the default values.
func NewContactsPostRequestBody_utm_parameters() *ContactsPostRequestBody_utm_parameters {
	m := &ContactsPostRequestBody_utm_parameters{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateContactsPostRequestBody_utm_parametersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateContactsPostRequestBody_utm_parametersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewContactsPostRequestBody_utm_parameters(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ContactsPostRequestBody_utm_parameters) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ContactsPostRequestBody_utm_parameters) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *ContactsPostRequestBody_utm_parameters) GetKeapSourceId() *string {
	return m.keap_source_id
}

// GetUtmCampaign gets the utm_campaign property value. UTM campaign information
// returns a *string when successful
func (m *ContactsPostRequestBody_utm_parameters) GetUtmCampaign() *string {
	return m.utm_campaign
}

// GetUtmContent gets the utm_content property value. UTM content information
// returns a *string when successful
func (m *ContactsPostRequestBody_utm_parameters) GetUtmContent() *string {
	return m.utm_content
}

// GetUtmMedium gets the utm_medium property value. UTM medium information
// returns a *string when successful
func (m *ContactsPostRequestBody_utm_parameters) GetUtmMedium() *string {
	return m.utm_medium
}

// GetUtmSource gets the utm_source property value. UTM source information
// returns a *string when successful
func (m *ContactsPostRequestBody_utm_parameters) GetUtmSource() *string {
	return m.utm_source
}

// GetUtmTerm gets the utm_term property value. UTM term information
// returns a *string when successful
func (m *ContactsPostRequestBody_utm_parameters) GetUtmTerm() *string {
	return m.utm_term
}

// Serialize serializes information the current object
func (m *ContactsPostRequestBody_utm_parameters) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ContactsPostRequestBody_utm_parameters) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetKeapSourceId sets the keap_source_id property value. The formId
func (m *ContactsPostRequestBody_utm_parameters) SetKeapSourceId(value *string) {
	m.keap_source_id = value
}

// SetUtmCampaign sets the utm_campaign property value. UTM campaign information
func (m *ContactsPostRequestBody_utm_parameters) SetUtmCampaign(value *string) {
	m.utm_campaign = value
}

// SetUtmContent sets the utm_content property value. UTM content information
func (m *ContactsPostRequestBody_utm_parameters) SetUtmContent(value *string) {
	m.utm_content = value
}

// SetUtmMedium sets the utm_medium property value. UTM medium information
func (m *ContactsPostRequestBody_utm_parameters) SetUtmMedium(value *string) {
	m.utm_medium = value
}

// SetUtmSource sets the utm_source property value. UTM source information
func (m *ContactsPostRequestBody_utm_parameters) SetUtmSource(value *string) {
	m.utm_source = value
}

// SetUtmTerm sets the utm_term property value. UTM term information
func (m *ContactsPostRequestBody_utm_parameters) SetUtmTerm(value *string) {
	m.utm_term = value
}

type ContactsPostRequestBody_utm_parametersable interface {
