...
type EmailsBatchAddPostResponse_emails struct {
...
// NewEmailsBatchAddPostResponse_emails instantiates a new EmailsBatchAddPostResponse_emails and sets the default values.
func NewEmailsBatchAddPostResponse_emails() *EmailsBatchAddPostResponse_emails {
	m := &EmailsBatchAddPostResponse_emails{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateEmailsBatchAddPostResponse_emailsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateEmailsBatchAddPostResponse_emailsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewEmailsBatchAddPostResponse_emails(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *EmailsBatchAddPostResponse_emails) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetClickedTime gets the clicked_time property value. The clicked_time property
// returns a *string when successful
func (m *EmailsBatchAddPostResponse_emails) GetClickedTime() *string {
	return m.clicked_time
}

// GetContactId gets the contact_id property value. The contact_id property
// returns a *string when successful
func (m *EmailsBatchAddPostResponse_emails) GetContactId() *string {
	return m.contact_id
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *EmailsBatchAddPostResponse_emails) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *EmailsBatchAddPostResponse_emails) GetSentFromReplyAddress() *string {
	return m.sent_from_reply_address
}

// GetSentTime gets the sent_time property value. The sent_time property
// returns a *string when successful
func (m *EmailsBatchAddPostResponse_emails) GetSentTime() *string {
	return m.sent_time
}

// GetSentToAddress gets the sent_to_address property value. The sent_to_address property
// returns a *string when successful
func (m *EmailsBatchAddPostResponse_emails) GetSentToAddress() *string {
...
// returns a []string when successful
func (m *EmailsBatchAddPostResponse_emails) GetSentToBccAddressList() []string {
...
// returns a []string when successful
func (m *EmailsBatchAddPostResponse_emails) GetSentToCcAddressList() []string {
	return m.sent_to_cc_address_list
}

// GetSubject gets the subject property value. The subject property
// returns a *string when successful
func (m *EmailsBatchAddPostResponse_emails) GetSubject() *string {
	return m.subject
}

// Serialize serializes information the current object
func (m *EmailsBatchAddPostResponse_emails) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *EmailsBatchAddPostResponse_emails) SetSentFromReplyAddress(value *string) {
	m.sent_from_reply_address = value
}

// SetSentTime sets the sent_time property value. The sent_time property
func (m *EmailsBatchAddPostResponse_emails) SetSentTime(value *string) {
	m.sent_time = value
}

// SetSentToAddress sets the sent_to_address property value. The sent_to_address property
func (m *EmailsBatchAddPostResponse_emails) SetSentToAddress(value *string) {
...
func (m *EmailsBatchAddPostResponse_emails) SetSentToBccAddressList(value []string) {
...
func (m *EmailsBatchAddPostResponse_emails) SetSentToCcAddressList(value []string) {
	m.sent_to_cc_address_list = value
}

// SetSubject sets the subject property value. The subject property
func (m *EmailsBatchAddPostResponse_emails) SetSubject(value *string) {
	m.subject = value
}

type EmailsBatchAddPostResponse_emailsable interface {
