...
type BusinessProfile403Error_stackTrace struct {
...
// NewBusinessProfile403Error_stackTrace instantiates a new BusinessProfile403Error_stackTrace and sets the default values.
func NewBusinessProfile403Error_stackTrace() *BusinessProfile403Error_stackTrace {
	m := &BusinessProfile403Error_stackTrace{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateBusinessProfile403Error_stackTraceFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateBusinessProfile403Error_stackTraceFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewBusinessProfile403Error_stackTrace(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *BusinessProfile403Error_stackTrace) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetClassLoaderName gets the classLoaderName property value. The classLoaderName property
// returns a *string when successful
func (m *BusinessProfile403Error_stackTrace) GetClassLoaderName() *string {
	return m.classLoaderName
}

// GetClassName gets the className property value. The className property
// returns a *string when successful
func (m *BusinessProfile403Error_stackTrace) GetClassName() *string {
	return m.className
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *BusinessProfile403Error_stackTrace) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *BusinessProfile403Error_stackTrace) GetFileName() *string {
	return m.fileName
}

// GetLineNumber gets the lineNumber property value. The lineNumber property
// returns a *int32 when successful
func (m *BusinessProfile403Error_stackTrace) GetLineNumber() *int32 {
	return m.lineNumber
}

// GetMethodName gets the methodName property value. The methodName property
// returns a *string when successful
func (m *BusinessProfile403Error_stackTrace) GetMethodName() *string {
	return m.methodName
}

// GetModuleName gets the moduleName property value. The moduleName property
// returns a *string when successful
func (m *BusinessProfile403Error_stackTrace) GetModuleName() *string {
	return m.moduleName
}

// GetModuleVersion gets the moduleVersion property value. The moduleVersion property
// returns a *string when successful
func (m *BusinessProfile403Error_stackTrace) GetModuleVersion() *string {
	return m.moduleVersion
}

// GetNativeMethod gets the nativeMethod property value. The nativeMethod property
// returns a *bool when successful
func (m *BusinessProfile403Error_stackTrace) GetNativeMethod() *bool {
	return m.nativeMethod
}

// Serialize serializes information the current object
func (m *BusinessProfile403Error_stackTrace) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *BusinessProfile403Error_stackTrace) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetClassLoaderName sets the classLoaderName property value. The classLoaderName property
func (m *BusinessProfile403Error_stackTrace) SetClassLoaderName(value *string) {
	m.classLoaderName = value
}

// SetClassName sets the className property value. The className property
func (m *BusinessProfile403Error_stackTrace) SetClassName(value *string) {
	m.className = value
}

// SetFileName sets the fileName property value. The fileName property
func (m *BusinessProfile403Error_stackTrace) SetFileName(value *string) {
	m.fileName = value
}

// SetLineNumber sets the lineNumber property value. The lineNumber property
func (m *BusinessProfile403Error_stackTrace) SetLineNumber(value *int32) {
	m.lineNumber = value
}

// SetMethodName sets the methodName property value. The methodName property
func (m *BusinessProfile403Error_stackTrace) SetMethodName(value *string) {
	m.methodName = value
}

// SetModuleName sets the moduleName property value. The moduleName property
func (m *BusinessProfile403Error_stackTrace) SetModuleName(value *string) {
	m.moduleName = value
}

// SetModuleVersion sets the moduleVersion property value. The moduleVersion property
func (m *BusinessProfile403Error_stackTrace) SetModuleVersion(value *string) {
	m.moduleVersion = value
}

// SetNativeMethod sets the nativeMethod property value. The nativeMethod property
func (m *BusinessProfile403Error_stackTrace) SetNativeMethod(value *bool) {
	m.nativeMethod = value
}

type BusinessProfile403Error_stackTraceable interface {
