...
type SettingsApplicationsGetConfigurationGetResponse_email struct {
...
// NewSettingsApplicationsGetConfigurationGetResponse_email instantiates a new SettingsApplicationsGetConfigurationGetResponse_email and sets the default values.
func NewSettingsApplicationsGetConfigurationGetResponse_email() *SettingsApplicationsGetConfigurationGetResponse_email {
	m := &SettingsApplicationsGetConfigurationGetResponse_email{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateSettingsApplicationsGetConfigurationGetResponse_emailFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateSettingsApplicationsGetConfigurationGetResponse_emailFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewSettingsApplicationsGetConfigurationGetResponse_email(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_email) GetAdditionalData() map[string]any {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) GetAppendContactKeyToLinks() *bool {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) GetDefaultOptInLink() *string {
...
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_email) GetDefaultOptOutLink() *string {
	return m.default_opt_out_link
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_email) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_email) GetHideEmailsToAndFromDomains() *string {
...
// returns a *string when successful
func (m *SettingsApplicationsGetConfigurationGetResponse_email) GetWhitelistedDomains() *string {
	return m.whitelisted_domains
}

// Serialize serializes information the current object
func (m *SettingsApplicationsGetConfigurationGetResponse_email) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) SetAdditionalData(value map[string]any) {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) SetAppendContactKeyToLinks(value *bool) {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) SetDefaultOptInLink(value *string) {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) SetDefaultOptOutLink(value *string) {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) SetHideEmailsToAndFromDomains(value *string) {
...
func (m *SettingsApplicationsGetConfigurationGetResponse_email) SetWhitelistedDomains(value *string) {
	m.whitelisted_domains = value
}

type SettingsApplicationsGetConfigurationGetResponse_emailable interface {
