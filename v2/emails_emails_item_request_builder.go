...
// EmailsEmailsItemRequestBuilder builds and executes requests for operations under \v2\emails\{id}
...
func NewEmailsEmailsItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *EmailsEmailsItemRequestBuilder {
	m := &EmailsEmailsItemRequestBuilder{
		BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/v2/emails/{id}", pathParameters),
	}
	return m
}
...
// Delete deletes a specific Email Record
...
// ToDeleteRequestInformation deletes a specific Email Record
