...
func NewSettingsApplicationsGetConfiguration404Error_suppressed() *SettingsApplicationsGetConfiguration404Error_suppressed {
	m := &SettingsApplicationsGetConfiguration404Error_suppressed{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateSettingsApplicationsGetConfiguration404Error_suppressedFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateSettingsApplicationsGetConfiguration404Error_suppressedFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewSettingsApplicationsGetConfiguration404Error_suppressed(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) GetAdditionalData() map[string]any {
...
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["stackTrace"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateSettingsApplicationsGetConfiguration404Error_suppressed_stackTraceFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]SettingsApplicationsGetConfiguration404Error_suppressed_stackTraceable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(SettingsApplicationsGetConfiguration404Error_suppressed_stackTraceable)
				}
			}
			m.SetStackTrace(res)
		}
...
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) GetLocalizedMessage() *string {
	return m.localizedMessage
}

// GetMessage gets the message property value. The message property
// returns a *string when successful
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) GetMessage() *string {
	return m.message
}

// GetStackTrace gets the stackTrace property value. The stackTrace property
// returns a []SettingsApplicationsGetConfiguration404Error_suppressed_stackTraceable when successful
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) GetStackTrace() []SettingsApplicationsGetConfiguration404Error_suppressed_stackTraceable {
	return m.stackTrace
}
...
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) SetAdditionalData(value map[string]any) {
...
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) SetLocalizedMessage(value *string) {
	m.localizedMessage = value
}

// SetMessage sets the message property value. The message property
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) SetMessage(value *string) {
	m.message = value
}

// SetStackTrace sets the stackTrace property value. The stackTrace property
func (m *SettingsApplicationsGetConfiguration404Error_suppressed) SetStackTrace(value []SettingsApplicationsGetConfiguration404Error_suppressed_stackTraceable) {
	m.stackTrace = value
}
