...
type FunnelIntegrationPostRequestBody_funnel_integration_triggers struct {
...
// NewFunnelIntegrationPostRequestBody_funnel_integration_triggers instantiates a new FunnelIntegrationPostRequestBody_funnel_integration_triggers and sets the default values.
func NewFunnelIntegrationPostRequestBody_funnel_integration_triggers() *FunnelIntegrationPostRequestBody_funnel_integration_triggers {
	m := &FunnelIntegrationPostRequestBody_funnel_integration_triggers{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateFunnelIntegrationPostRequestBody_funnel_integration_triggersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateFunnelIntegrationPostRequestBody_funnel_integration_triggersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewFunnelIntegrationPostRequestBody_funnel_integration_triggers(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetAdditionalData() map[string]any {
...
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetBaseUrl() *string {
	return m.base_url
}
...
// returns a *string when successful
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetContext() *string {
	return m.context
}

// GetEnabled gets the enabled property value. The flag to enable or disable the integration trigger.
// returns a *bool when successful
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetEnabled() *bool {
	return m.enabled
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetFunnelSchemaJson() *string {
...
// returns a *string when successful
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetIconUrl() *string {
	return m.icon_url
}
...
// returns a *string when successful
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) GetName() *string {
	return m.name
}

// Serialize serializes information the current object
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) SetAdditionalData(value map[string]any) {
...
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) SetBaseUrl(value *string) {
	m.base_url = value
}
...
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) SetContext(value *string) {
	m.context = value
}

// SetEnabled sets the enabled property value. The flag to enable or disable the integration trigger.
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) SetEnabled(value *bool) {
	m.enabled = value
}
...
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) SetFunnelSchemaJson(value *string) {
...
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) SetIconUrl(value *string) {
	m.icon_url = value
}
...
func (m *FunnelIntegrationPostRequestBody_funnel_integration_triggers) SetName(value *string) {
	m.name = value
}

type FunnelIntegrationPostRequestBody_funnel_integration_triggersable interface {
