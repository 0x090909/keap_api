...
type CompaniesItemWithCompany_GetResponse_address struct {
...
// NewCompaniesItemWithCompany_GetResponse_address instantiates a new CompaniesItemWithCompany_GetResponse_address and sets the default values.
func NewCompaniesItemWithCompany_GetResponse_address() *CompaniesItemWithCompany_GetResponse_address {
	m := &CompaniesItemWithCompany_GetResponse_address{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateCompaniesItemWithCompany_GetResponse_addressFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateCompaniesItemWithCompany_GetResponse_addressFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewCompaniesItemWithCompany_GetResponse_address(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCountry gets the country property value. The long-name descriptive version of the Country Code
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetCountry() *string {
	return m.country
}
...
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetCountryCode() *string {
	return m.country_code
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetLine1() *string {
	return m.line1
}

// GetLine2 gets the line2 property value. The line2 property
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetLine2() *string {
	return m.line2
}

// GetLocality gets the locality property value. The municipality to which the address belongs
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetLocality() *string {
	return m.locality
}

// GetPostalCode gets the postal_code property value. The postal_code property
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetPostalCode() *string {
	return m.postal_code
}

// GetRegion gets the region property value. The long-name descriptive version of the Region Code
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetRegion() *string {
	return m.region
}
...
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetRegionCode() *string {
	return m.region_code
}

// GetZipCode gets the zip_code property value. The zip_code property
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetZipCode() *string {
	return m.zip_code
}

// GetZipFour gets the zip_four property value. The zip_four property
// returns a *string when successful
func (m *CompaniesItemWithCompany_GetResponse_address) GetZipFour() *string {
	return m.zip_four
}

// Serialize serializes information the current object
func (m *CompaniesItemWithCompany_GetResponse_address) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *CompaniesItemWithCompany_GetResponse_address) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCountry sets the country property value. The long-name descriptive version of the Country Code
func (m *CompaniesItemWithCompany_GetResponse_address) SetCountry(value *string) {
	m.country = value
}
...
func (m *CompaniesItemWithCompany_GetResponse_address) SetCountryCode(value *string) {
	m.country_code = value
}

// SetLine1 sets the line1 property value. The line1 property
func (m *CompaniesItemWithCompany_GetResponse_address) SetLine1(value *string) {
	m.line1 = value
}

// SetLine2 sets the line2 property value. The line2 property
func (m *CompaniesItemWithCompany_GetResponse_address) SetLine2(value *string) {
	m.line2 = value
}

// SetLocality sets the locality property value. The municipality to which the address belongs
func (m *CompaniesItemWithCompany_GetResponse_address) SetLocality(value *string) {
	m.locality = value
}

// SetPostalCode sets the postal_code property value. The postal_code property
func (m *CompaniesItemWithCompany_GetResponse_address) SetPostalCode(value *string) {
	m.postal_code = value
}

// SetRegion sets the region property value. The long-name descriptive version of the Region Code
func (m *CompaniesItemWithCompany_GetResponse_address) SetRegion(value *string) {
	m.region = value
}
...
func (m *CompaniesItemWithCompany_GetResponse_address) SetRegionCode(value *string) {
	m.region_code = value
}

// SetZipCode sets the zip_code property value. The zip_code property
func (m *CompaniesItemWithCompany_GetResponse_address) SetZipCode(value *string) {
	m.zip_code = value
}

// SetZipFour sets the zip_four property value. The zip_four property
func (m *CompaniesItemWithCompany_GetResponse_address) SetZipFour(value *string) {
	m.zip_four = value
}

type CompaniesItemWithCompany_GetResponse_addressable interface {
