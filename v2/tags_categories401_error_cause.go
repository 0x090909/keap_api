...
type TagsCategories401Error_cause struct {
	...
	stackTrace []TagsCategories401Error_cause_stackTraceable
	// The suppressed property
	suppressed []ia90dd1409a2ba05682b4d7b08237e40a27cab9440e9a81b916d31aca6dbec751.Throwableable
}

// NewTagsCategories401Error_cause instantiates a new TagsCategories401Error_cause and sets the default values.
func NewTagsCategories401Error_cause() *TagsCategories401Error_cause {
	m := &TagsCategories401Error_cause{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateTagsCategories401Error_causeFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateTagsCategories401Error_causeFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewTagsCategories401Error_cause(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *TagsCategories401Error_cause) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCause gets the cause property value. The cause property
// returns a Throwableable when successful
func (m *TagsCategories401Error_cause) GetCause() ia90dd1409a2ba05682b4d7b08237e40a27cab9440e9a81b916d31aca6dbec751.Throwableable {
	return m.cause
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *TagsCategories401Error_cause) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["stackTrace"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateTagsCategories401Error_cause_stackTraceFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]TagsCategories401Error_cause_stackTraceable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(TagsCategories401Error_cause_stackTraceable)
				}
			}
			m.SetStackTrace(res)
		}
...
func (m *TagsCategories401Error_cause) GetLocalizedMessage() *string {
	return m.localizedMessage
}

// GetMessage gets the message property value. The message property
// returns a *string when successful
func (m *TagsCategories401Error_cause) GetMessage() *string {
	return m.message
}

// GetStackTrace gets the stackTrace property value. The stackTrace property
// returns a []TagsCategories401Error_cause_stackTraceable when successful
func (m *TagsCategories401Error_cause) GetStackTrace() []TagsCategories401Error_cause_stackTraceable {
	return m.stackTrace
}

// GetSuppressed gets the suppressed property value. The suppressed property
// returns a []Throwableable when successful
func (m *TagsCategories401Error_cause) GetSuppressed() []ia90dd1409a2ba05682b4d7b08237e40a27cab9440e9a81b916d31aca6dbec751.Throwableable {
	return m.suppressed
}

// Serialize serializes information the current object
func (m *TagsCategories401Error_cause) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *TagsCategories401Error_cause) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCause sets the cause property value. The cause property
func (m *TagsCategories401Error_cause) SetCause(value ia90dd1409a2ba05682b4d7b08237e40a27cab9440e9a81b916d31aca6dbec751.Throwableable) {
	m.cause = value
}

// SetLocalizedMessage sets the localizedMessage property value. The localizedMessage property
func (m *TagsCategories401Error_cause) SetLocalizedMessage(value *string) {
	m.localizedMessage = value
}

// SetMessage sets the message property value. The message property
func (m *TagsCategories401Error_cause) SetMessage(value *string) {
	m.message = value
}

// SetStackTrace sets the stackTrace property value. The stackTrace property
func (m *TagsCategories401Error_cause) SetStackTrace(value []TagsCategories401Error_cause_stackTraceable) {
	m.stackTrace = value
}

// SetSuppressed sets the suppressed property value. The suppressed property
func (m *TagsCategories401Error_cause) SetSuppressed(value []ia90dd1409a2ba05682b4d7b08237e40a27cab9440e9a81b916d31aca6dbec751.Throwableable) {
	m.suppressed = value
}

type TagsCategories401Error_causeable interface {
	...
	GetMessage() *string
	GetStackTrace() []TagsCategories401Error_cause_stackTraceable
	...
	SetStackTrace(value []TagsCategories401Error_cause_stackTraceable)
