...
type AutomationsGetResponse_automations struct {
...
// NewAutomationsGetResponse_automations instantiates a new AutomationsGetResponse_automations and sets the default values.
func NewAutomationsGetResponse_automations() *AutomationsGetResponse_automations {
	m := &AutomationsGetResponse_automations{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateAutomationsGetResponse_automationsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateAutomationsGetResponse_automationsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewAutomationsGetResponse_automations(), nil
}

// GetActiveContacts gets the active_contacts property value. The active_contacts property
// returns a *int32 when successful
func (m *AutomationsGetResponse_automations) GetActiveContacts() *int32 {
	return m.active_contacts
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *AutomationsGetResponse_automations) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCategories gets the categories property value. The categories property
// returns a []string when successful
func (m *AutomationsGetResponse_automations) GetCategories() []string {
	return m.categories
}

// GetErrorMessage gets the error_message property value. The error_message property
// returns a *string when successful
func (m *AutomationsGetResponse_automations) GetErrorMessage() *string {
	return m.error_message
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *AutomationsGetResponse_automations) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *AutomationsGetResponse_automations) GetId() *string {
	return m.id
}

// GetPublishedBy gets the published_by property value. The published_by property
// returns a *string when successful
func (m *AutomationsGetResponse_automations) GetPublishedBy() *string {
	return m.published_by
}

// GetPublishedDate gets the published_date property value. The published_date property
// returns a *Time when successful
func (m *AutomationsGetResponse_automations) GetPublishedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.published_date
}

// GetPublishedTimezone gets the published_timezone property value. The published_timezone property
// returns a *string when successful
func (m *AutomationsGetResponse_automations) GetPublishedTimezone() *string {
	return m.published_timezone
}

// GetStatus gets the status property value. The status property
// returns a *string when successful
func (m *AutomationsGetResponse_automations) GetStatus() *string {
	return m.status
}

// GetTitle gets the title property value. The title property
// returns a *string when successful
func (m *AutomationsGetResponse_automations) GetTitle() *string {
	return m.title
}

// Serialize serializes information the current object
func (m *AutomationsGetResponse_automations) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *AutomationsGetResponse_automations) SetActiveContacts(value *int32) {
	m.active_contacts = value
}

// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *AutomationsGetResponse_automations) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCategories sets the categories property value. The categories property
func (m *AutomationsGetResponse_automations) SetCategories(value []string) {
	m.categories = value
}

// SetErrorMessage sets the error_message property value. The error_message property
func (m *AutomationsGetResponse_automations) SetErrorMessage(value *string) {
	m.error_message = value
}

// SetId sets the id property value. The id property
func (m *AutomationsGetResponse_automations) SetId(value *string) {
	m.id = value
}

// SetPublishedBy sets the published_by property value. The published_by property
func (m *AutomationsGetResponse_automations) SetPublishedBy(value *string) {
	m.published_by = value
}

// SetPublishedDate sets the published_date property value. The published_date property
func (m *AutomationsGetResponse_automations) SetPublishedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.published_date = value
}

// SetPublishedTimezone sets the published_timezone property value. The published_timezone property
func (m *AutomationsGetResponse_automations) SetPublishedTimezone(value *string) {
	m.published_timezone = value
}

// SetStatus sets the status property value. The status property
func (m *AutomationsGetResponse_automations) SetStatus(value *string) {
	m.status = value
}

// SetTitle sets the title property value. The title property
func (m *AutomationsGetResponse_automations) SetTitle(value *string) {
	m.title = value
}

type AutomationsGetResponse_automationsable interface {
