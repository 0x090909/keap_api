...
func (m *CampaignsGetResponse_campaigns) GetActiveContactCount() *int32 {
...
// returns a *int32 when successful
func (m *CampaignsGetResponse_campaigns) GetCompletedContactCount() *int32 {
...
func (m *CampaignsGetResponse_campaigns) GetCreatedByGlobalId() *string {
	return m.created_by_global_id
}

// GetDateCreated gets the date_created property value. The date_created property
// returns a *string when successful
func (m *CampaignsGetResponse_campaigns) GetDateCreated() *string {
...
// returns a *string when successful
func (m *CampaignsGetResponse_campaigns) GetId() *string {
	return m.id
}
...
func (m *CampaignsGetResponse_campaigns) SetActiveContactCount(value *int32) {
...
func (m *CampaignsGetResponse_campaigns) SetCompletedContactCount(value *int32) {
...
func (m *CampaignsGetResponse_campaigns) SetCreatedByGlobalId(value *string) {
	m.created_by_global_id = value
}

// SetDateCreated sets the date_created property value. The date_created property
func (m *CampaignsGetResponse_campaigns) SetDateCreated(value *string) {
...
func (m *CampaignsGetResponse_campaigns) SetId(value *string) {
	m.id = value
}
