...
// EmailAddressesRequestBuilder builds and executes requests for operations under \v2\emailAddresses
type EmailAddressesRequestBuilder struct {
	i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}

// ByEmail gets an item from the github.com/0x090909/keap_api.v2.emailAddresses.item collection
...
func NewEmailAddressesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *EmailAddressesRequestBuilder {
	m := &EmailAddressesRequestBuilder{
		BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/v2/emailAddresses", pathParameters),
	}
	return m
}
