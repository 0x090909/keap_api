...
type ProductsItemWithProductPatchRequestBody struct {
	// The active property
	active *bool
...
// NewProductsItemWithProductPatchRequestBody instantiates a new ProductsItemWithProductPatchRequestBody and sets the default values.
func NewProductsItemWithProductPatchRequestBody() *ProductsItemWithProductPatchRequestBody {
	m := &ProductsItemWithProductPatchRequestBody{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateProductsItemWithProductPatchRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateProductsItemWithProductPatchRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewProductsItemWithProductPatchRequestBody(), nil
}

// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *ProductsItemWithProductPatchRequestBody) GetActive() *bool {
	return m.active
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ProductsItemWithProductPatchRequestBody) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ProductsItemWithProductPatchRequestBody) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *ProductsItemWithProductPatchRequestBody) GetProductDesc() *string {
	return m.product_desc
}

// GetProductName gets the product_name property value. The product_name property
// returns a *string when successful
func (m *ProductsItemWithProductPatchRequestBody) GetProductName() *string {
	return m.product_name
}

// GetProductPrice gets the product_price property value. The product_price property
// returns a *float64 when successful
func (m *ProductsItemWithProductPatchRequestBody) GetProductPrice() *float64 {
	return m.product_price
}

// GetProductShortDesc gets the product_short_desc property value. The product_short_desc property
// returns a *string when successful
func (m *ProductsItemWithProductPatchRequestBody) GetProductShortDesc() *string {
	return m.product_short_desc
}

// GetSku gets the sku property value. The sku property
// returns a *string when successful
func (m *ProductsItemWithProductPatchRequestBody) GetSku() *string {
	return m.sku
}

// GetSubscriptionOnly gets the subscription_only property value. The subscription_only property
// returns a *bool when successful
func (m *ProductsItemWithProductPatchRequestBody) GetSubscriptionOnly() *bool {
	return m.subscription_only
}

// Serialize serializes information the current object
func (m *ProductsItemWithProductPatchRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ProductsItemWithProductPatchRequestBody) SetActive(value *bool) {
	m.active = value
}

// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ProductsItemWithProductPatchRequestBody) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetProductDesc sets the product_desc property value. The product_desc property
func (m *ProductsItemWithProductPatchRequestBody) SetProductDesc(value *string) {
	m.product_desc = value
}

// SetProductName sets the product_name property value. The product_name property
func (m *ProductsItemWithProductPatchRequestBody) SetProductName(value *string) {
	m.product_name = value
}

// SetProductPrice sets the product_price property value. The product_price property
func (m *ProductsItemWithProductPatchRequestBody) SetProductPrice(value *float64) {
	m.product_price = value
}

// SetProductShortDesc sets the product_short_desc property value. The product_short_desc property
func (m *ProductsItemWithProductPatchRequestBody) SetProductShortDesc(value *string) {
	m.product_short_desc = value
}

// SetSku sets the sku property value. The sku property
func (m *ProductsItemWithProductPatchRequestBody) SetSku(value *string) {
	m.sku = value
}

// SetSubscriptionOnly sets the subscription_only property value. The subscription_only property
func (m *ProductsItemWithProductPatchRequestBody) SetSubscriptionOnly(value *bool) {
	m.subscription_only = value
}

type ProductsItemWithProductPatchRequestBodyable interface {
