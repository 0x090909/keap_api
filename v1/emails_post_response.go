...
func (m *EmailsPostResponse) GetClickedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.clicked_date
}

// GetContactId gets the contact_id property value. The contact_id property
// returns a *int64 when successful
func (m *EmailsPostResponse) GetContactId() *int64 {
	return m.contact_id
}
...
// returns a *int64 when successful
func (m *EmailsPostResponse) GetId() *int64 {
	return m.id
}

// GetOpenedDate gets the opened_date property value. The opened_date property
// returns a *Time when successful
func (m *EmailsPostResponse) GetOpenedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
// returns a *Time when successful
func (m *EmailsPostResponse) GetReceivedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.received_date
}

// GetSentDate gets the sent_date property value. The sent_date property
// returns a *Time when successful
func (m *EmailsPostResponse) GetSentDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.sent_date
}
...
// returns a *string when successful
func (m *EmailsPostResponse) GetSentToBccAddresses() *string {
...
// returns a *string when successful
func (m *EmailsPostResponse) GetSentToCcAddresses() *string {
...
func (m *EmailsPostResponse) SetClickedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.clicked_date = value
}

// SetContactId sets the contact_id property value. The contact_id property
func (m *EmailsPostResponse) SetContactId(value *int64) {
	m.contact_id = value
}
...
func (m *EmailsPostResponse) SetId(value *int64) {
	m.id = value
}

// SetOpenedDate sets the opened_date property value. The opened_date property
func (m *EmailsPostResponse) SetOpenedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.opened_date = value
}
...
func (m *EmailsPostResponse) SetReceivedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.received_date = value
}

// SetSentDate sets the sent_date property value. The sent_date property
func (m *EmailsPostResponse) SetSentDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.sent_date = value
}
...
func (m *EmailsPostResponse) SetSentToBccAddresses(value *string) {
...
func (m *EmailsPostResponse) SetSentToCcAddresses(value *string) {
