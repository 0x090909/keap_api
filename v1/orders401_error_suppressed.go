...
type Orders401Error_suppressed struct {
	...
	stackTrace []Orders401Error_suppressed_stackTraceable
	// The suppressed property
	suppressed []ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable
}

// NewOrders401Error_suppressed instantiates a new Orders401Error_suppressed and sets the default values.
func NewOrders401Error_suppressed() *Orders401Error_suppressed {
	m := &Orders401Error_suppressed{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOrders401Error_suppressedFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOrders401Error_suppressedFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOrders401Error_suppressed(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *Orders401Error_suppressed) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCause gets the cause property value. The cause property
// returns a Throwableable when successful
func (m *Orders401Error_suppressed) GetCause() ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable {
	return m.cause
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *Orders401Error_suppressed) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["stackTrace"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateOrders401Error_suppressed_stackTraceFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]Orders401Error_suppressed_stackTraceable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(Orders401Error_suppressed_stackTraceable)
				}
			}
			m.SetStackTrace(res)
		}
...
func (m *Orders401Error_suppressed) GetLocalizedMessage() *string {
	return m.localizedMessage
}

// GetMessage gets the message property value. The message property
// returns a *string when successful
func (m *Orders401Error_suppressed) GetMessage() *string {
	return m.message
}

// GetStackTrace gets the stackTrace property value. The stackTrace property
// returns a []Orders401Error_suppressed_stackTraceable when successful
func (m *Orders401Error_suppressed) GetStackTrace() []Orders401Error_suppressed_stackTraceable {
	return m.stackTrace
}

// GetSuppressed gets the suppressed property value. The suppressed property
// returns a []Throwableable when successful
func (m *Orders401Error_suppressed) GetSuppressed() []ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable {
	return m.suppressed
}

// Serialize serializes information the current object
func (m *Orders401Error_suppressed) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *Orders401Error_suppressed) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCause sets the cause property value. The cause property
func (m *Orders401Error_suppressed) SetCause(value ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable) {
	m.cause = value
}

// SetLocalizedMessage sets the localizedMessage property value. The localizedMessage property
func (m *Orders401Error_suppressed) SetLocalizedMessage(value *string) {
	m.localizedMessage = value
}

// SetMessage sets the message property value. The message property
func (m *Orders401Error_suppressed) SetMessage(value *string) {
	m.message = value
}

// SetStackTrace sets the stackTrace property value. The stackTrace property
func (m *Orders401Error_suppressed) SetStackTrace(value []Orders401Error_suppressed_stackTraceable) {
	m.stackTrace = value
}

// SetSuppressed sets the suppressed property value. The suppressed property
func (m *Orders401Error_suppressed) SetSuppressed(value []ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable) {
	m.suppressed = value
}

type Orders401Error_suppressedable interface {
	...
	GetMessage() *string
	GetStackTrace() []Orders401Error_suppressed_stackTraceable
	...
	SetStackTrace(value []Orders401Error_suppressed_stackTraceable)
