...
type OpportunitiesItemWithOpportunityPatchResponse struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// The affiliate_id property
	affiliate_id *int64
	// The contact property
	contact OpportunitiesItemWithOpportunityPatchResponse_contactable
	// The custom_fields property
	custom_fields []OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable
	...
	// The stage property
	stage OpportunitiesItemWithOpportunityPatchResponse_stageable
	// The user property
	user OpportunitiesItemWithOpportunityPatchResponse_userable
}

// NewOpportunitiesItemWithOpportunityPatchResponse instantiates a new OpportunitiesItemWithOpportunityPatchResponse and sets the default values.
func NewOpportunitiesItemWithOpportunityPatchResponse() *OpportunitiesItemWithOpportunityPatchResponse {
	m := &OpportunitiesItemWithOpportunityPatchResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOpportunitiesItemWithOpportunityPatchResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOpportunitiesItemWithOpportunityPatchResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOpportunitiesItemWithOpportunityPatchResponse(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAffiliateId gets the affiliate_id property value. The affiliate_id property
// returns a *int64 when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetAffiliateId() *int64 {
	return m.affiliate_id
}

// GetContact gets the contact property value. The contact property
// returns a OpportunitiesItemWithOpportunityPatchResponse_contactable when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetContact() OpportunitiesItemWithOpportunityPatchResponse_contactable {
	return m.contact
}

// GetCustomFields gets the custom_fields property value. The custom_fields property
// returns a []OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetCustomFields() []OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable {
	return m.custom_fields
}

// GetDateCreated gets the date_created property value. The date_created property
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetDateCreated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetEstimatedCloseDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.estimated_close_date
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesItemWithOpportunityPatchResponse_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(OpportunitiesItemWithOpportunityPatchResponse_contactable))
		}
		return nil
	}
	res["custom_fields"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateOpportunitiesItemWithOpportunityPatchResponse_custom_fieldsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable)
				}
			}
	...
	res["stage"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesItemWithOpportunityPatchResponse_stageFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetStage(val.(OpportunitiesItemWithOpportunityPatchResponse_stageable))
		}
		return nil
	}
	res["user"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesItemWithOpportunityPatchResponse_userFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetUser(val.(OpportunitiesItemWithOpportunityPatchResponse_userable))
		}
		return nil
	}
	return res
...
// returns a *int64 when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetId() *int64 {
	return m.id
}

// GetIncludeInForecast gets the include_in_forecast property value. The include_in_forecast property
// returns a *int32 when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetIncludeInForecast() *int32 {
	return m.include_in_forecast
}

// GetLastUpdated gets the last_updated property value. The last_updated property
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetLastUpdated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.last_updated
}

// GetNextActionDate gets the next_action_date property value. The next_action_date property
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetNextActionDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetNextActionNotes() *string {
	return m.next_action_notes
}

// GetOpportunityNotes gets the opportunity_notes property value. The opportunity_notes property
// returns a *string when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetOpportunityNotes() *string {
	return m.opportunity_notes
}

// GetOpportunityTitle gets the opportunity_title property value. The opportunity_title property
// returns a *string when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetOpportunityTitle() *string {
...
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetProjectedRevenueHigh() *float64 {
...
// returns a *float64 when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetProjectedRevenueLow() *float64 {
	return m.projected_revenue_low
}

// GetStage gets the stage property value. The stage property
// returns a OpportunitiesItemWithOpportunityPatchResponse_stageable when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetStage() OpportunitiesItemWithOpportunityPatchResponse_stageable {
	return m.stage
}

// GetUser gets the user property value. The user property
// returns a OpportunitiesItemWithOpportunityPatchResponse_userable when successful
func (m *OpportunitiesItemWithOpportunityPatchResponse) GetUser() OpportunitiesItemWithOpportunityPatchResponse_userable {
	return m.user
}

// Serialize serializes information the current object
func (m *OpportunitiesItemWithOpportunityPatchResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetAffiliateId sets the affiliate_id property value. The affiliate_id property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetAffiliateId(value *int64) {
	m.affiliate_id = value
}

// SetContact sets the contact property value. The contact property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetContact(value OpportunitiesItemWithOpportunityPatchResponse_contactable) {
	m.contact = value
}

// SetCustomFields sets the custom_fields property value. The custom_fields property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetCustomFields(value []OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable) {
	m.custom_fields = value
}

// SetDateCreated sets the date_created property value. The date_created property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetDateCreated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.date_created = value
}

// SetEstimatedCloseDate sets the estimated_close_date property value. The estimated_close_date property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetEstimatedCloseDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.estimated_close_date = value
}

// SetId sets the id property value. The id property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetId(value *int64) {
	m.id = value
}

// SetIncludeInForecast sets the include_in_forecast property value. The include_in_forecast property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetIncludeInForecast(value *int32) {
	m.include_in_forecast = value
}

// SetLastUpdated sets the last_updated property value. The last_updated property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetLastUpdated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.last_updated = value
}

// SetNextActionDate sets the next_action_date property value. The next_action_date property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetNextActionDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.next_action_date = value
}

// SetNextActionNotes sets the next_action_notes property value. The next_action_notes property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetNextActionNotes(value *string) {
	m.next_action_notes = value
}

// SetOpportunityNotes sets the opportunity_notes property value. The opportunity_notes property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetOpportunityNotes(value *string) {
	m.opportunity_notes = value
}

// SetOpportunityTitle sets the opportunity_title property value. The opportunity_title property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetOpportunityTitle(value *string) {
...
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetProjectedRevenueHigh(value *float64) {
...
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetProjectedRevenueLow(value *float64) {
	m.projected_revenue_low = value
}

// SetStage sets the stage property value. The stage property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetStage(value OpportunitiesItemWithOpportunityPatchResponse_stageable) {
	m.stage = value
}

// SetUser sets the user property value. The user property
func (m *OpportunitiesItemWithOpportunityPatchResponse) SetUser(value OpportunitiesItemWithOpportunityPatchResponse_userable) {
	m.user = value
}

type OpportunitiesItemWithOpportunityPatchResponseable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAffiliateId() *int64
	GetContact() OpportunitiesItemWithOpportunityPatchResponse_contactable
	GetCustomFields() []OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable
	...
	GetStage() OpportunitiesItemWithOpportunityPatchResponse_stageable
	GetUser() OpportunitiesItemWithOpportunityPatchResponse_userable
	SetAffiliateId(value *int64)
	SetContact(value OpportunitiesItemWithOpportunityPatchResponse_contactable)
	SetCustomFields(value []OpportunitiesItemWithOpportunityPatchResponse_custom_fieldsable)
	...
	SetStage(value OpportunitiesItemWithOpportunityPatchResponse_stageable)
	SetUser(value OpportunitiesItemWithOpportunityPatchResponse_userable)
}
