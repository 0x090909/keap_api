...
// GetCreditCardId gets the credit_card_id property value. Default is the contact's most recently used card, if auto charge is true. Default is 0 otherwise.
// returns a *int64 when successful
func (m *SubscriptionsPostRequestBody) GetCreditCardId() *int64 {
...
// GetPaymentGatewayId gets the payment_gateway_id property value. Default is the app's default merchant.
// returns a *int64 when successful
func (m *SubscriptionsPostRequestBody) GetPaymentGatewayId() *int64 {
...
// SetCreditCardId sets the credit_card_id property value. Default is the contact's most recently used card, if auto charge is true. Default is 0 otherwise.
func (m *SubscriptionsPostRequestBody) SetCreditCardId(value *int64) {
...
// SetPaymentGatewayId sets the payment_gateway_id property value. Default is the app's default merchant.
func (m *SubscriptionsPostRequestBody) SetPaymentGatewayId(value *int64) {
