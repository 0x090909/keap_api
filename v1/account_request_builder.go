...
// AccountRequestBuilder builds and executes requests for operations under \v1\account
...
func NewAccountRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter) *AccountRequestBuilder {
	m := &AccountRequestBuilder{
		BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/v1/account", pathParameters),
	}
	return m
}
...
func (m *AccountRequestBuilder) Profile() *AccountProfileRequestBuilder {
	return NewAccountProfileRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
