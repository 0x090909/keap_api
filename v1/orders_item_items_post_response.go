...
type OrdersItemItemsPostResponse struct {
	...
	orderItemTaxes []OrdersItemItemsPostResponse_orderItemTaxesable
	// The price property
	price *float64
	// The product property
	product OrdersItemItemsPostResponse_productable
...
// NewOrdersItemItemsPostResponse instantiates a new OrdersItemItemsPostResponse and sets the default values.
func NewOrdersItemItemsPostResponse() *OrdersItemItemsPostResponse {
	m := &OrdersItemItemsPostResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOrdersItemItemsPostResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOrdersItemItemsPostResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOrdersItemItemsPostResponse(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OrdersItemItemsPostResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetBillingCycle gets the billingCycle property value. The billingCycle property
// returns a *int32 when successful
func (m *OrdersItemItemsPostResponse) GetBillingCycle() *int32 {
	return m.billingCycle
}

// GetCost gets the cost property value. The cost property
// returns a *float64 when successful
func (m *OrdersItemItemsPostResponse) GetCost() *float64 {
	return m.cost
}

// GetDescription gets the description property value. The description property
// returns a *string when successful
func (m *OrdersItemItemsPostResponse) GetDescription() *string {
	return m.description
}

// GetDiscount gets the discount property value. The discount property
// returns a *float64 when successful
func (m *OrdersItemItemsPostResponse) GetDiscount() *float64 {
	return m.discount
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OrdersItemItemsPostResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["orderItemTaxes"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateOrdersItemItemsPostResponse_orderItemTaxesFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]OrdersItemItemsPostResponse_orderItemTaxesable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(OrdersItemItemsPostResponse_orderItemTaxesable)
				}
			}
	...
	res["product"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOrdersItemItemsPostResponse_productFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetProduct(val.(OrdersItemItemsPostResponse_productable))
		}
		return nil
	}
...
// returns a *int32 when successful
func (m *OrdersItemItemsPostResponse) GetFrequency() *int32 {
	return m.frequency
}

// GetId gets the id property value. The id property
// returns a *int64 when successful
func (m *OrdersItemItemsPostResponse) GetId() *int64 {
	return m.id
}

// GetJobRecurringId gets the jobRecurringId property value. The jobRecurringId property
// returns a *int64 when successful
func (m *OrdersItemItemsPostResponse) GetJobRecurringId() *int64 {
	return m.jobRecurringId
}

// GetName gets the name property value. The name property
// returns a *string when successful
func (m *OrdersItemItemsPostResponse) GetName() *string {
	return m.name
}

// GetNotes gets the notes property value. The notes property
// returns a *string when successful
func (m *OrdersItemItemsPostResponse) GetNotes() *string {
	return m.notes
}

// GetNumberOfPayments gets the numberOfPayments property value. The numberOfPayments property
// returns a *int32 when successful
func (m *OrdersItemItemsPostResponse) GetNumberOfPayments() *int32 {
	return m.numberOfPayments
}

// GetOrderItemTaxes gets the orderItemTaxes property value. The orderItemTaxes property
// returns a []OrdersItemItemsPostResponse_orderItemTaxesable when successful
func (m *OrdersItemItemsPostResponse) GetOrderItemTaxes() []OrdersItemItemsPostResponse_orderItemTaxesable {
	return m.orderItemTaxes
}

// GetPrice gets the price property value. The price property
// returns a *float64 when successful
func (m *OrdersItemItemsPostResponse) GetPrice() *float64 {
	return m.price
}

// GetProduct gets the product property value. The product property
// returns a OrdersItemItemsPostResponse_productable when successful
func (m *OrdersItemItemsPostResponse) GetProduct() OrdersItemItemsPostResponse_productable {
	return m.product
}

// GetQuantity gets the quantity property value. The quantity property
// returns a *int32 when successful
func (m *OrdersItemItemsPostResponse) GetQuantity() *int32 {
	return m.quantity
}

// GetRecurringBilling gets the recurringBilling property value. The recurringBilling property
// returns a *bool when successful
func (m *OrdersItemItemsPostResponse) GetRecurringBilling() *bool {
...
// returns a *int32 when successful
func (m *OrdersItemItemsPostResponse) GetRecurringCyclesCompleted() *int32 {
...
// returns a *string when successful
func (m *OrdersItemItemsPostResponse) GetRecurringEndDate() *string {
	return m.recurringEndDate
}

// GetRecurringInactive gets the recurringInactive property value. The recurringInactive property
// returns a *bool when successful
func (m *OrdersItemItemsPostResponse) GetRecurringInactive() *bool {
...
// returns a *string when successful
func (m *OrdersItemItemsPostResponse) GetRecurringNextBillDate() *string {
...
// returns a *string when successful
func (m *OrdersItemItemsPostResponse) GetRecurringStartDate() *string {
	return m.recurringStartDate
}

// GetSpecialAmount gets the specialAmount property value. The specialAmount property
// returns a *float64 when successful
func (m *OrdersItemItemsPostResponse) GetSpecialAmount() *float64 {
	return m.specialAmount
}

// GetSpecialId gets the specialId property value. The specialId property
// returns a *int64 when successful
func (m *OrdersItemItemsPostResponse) GetSpecialId() *int64 {
	return m.specialId
}

// GetSpecialPctOrAmt gets the specialPctOrAmt property value. The specialPctOrAmt property
// returns a *int32 when successful
func (m *OrdersItemItemsPostResponse) GetSpecialPctOrAmt() *int32 {
	return m.specialPctOrAmt
}

// GetTypeEscaped gets the type property value. The type property
// returns a *string when successful
func (m *OrdersItemItemsPostResponse) GetTypeEscaped() *string {
	return m.typeEscaped
}

// Serialize serializes information the current object
func (m *OrdersItemItemsPostResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *OrdersItemItemsPostResponse) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetBillingCycle sets the billingCycle property value. The billingCycle property
func (m *OrdersItemItemsPostResponse) SetBillingCycle(value *int32) {
	m.billingCycle = value
}

// SetCost sets the cost property value. The cost property
func (m *OrdersItemItemsPostResponse) SetCost(value *float64) {
	m.cost = value
}

// SetDescription sets the description property value. The description property
func (m *OrdersItemItemsPostResponse) SetDescription(value *string) {
	m.description = value
}

// SetDiscount sets the discount property value. The discount property
func (m *OrdersItemItemsPostResponse) SetDiscount(value *float64) {
	m.discount = value
}

// SetFrequency sets the frequency property value. The frequency property
func (m *OrdersItemItemsPostResponse) SetFrequency(value *int32) {
	m.frequency = value
}

// SetId sets the id property value. The id property
func (m *OrdersItemItemsPostResponse) SetId(value *int64) {
	m.id = value
}

// SetJobRecurringId sets the jobRecurringId property value. The jobRecurringId property
func (m *OrdersItemItemsPostResponse) SetJobRecurringId(value *int64) {
	m.jobRecurringId = value
}

// SetName sets the name property value. The name property
func (m *OrdersItemItemsPostResponse) SetName(value *string) {
	m.name = value
}

// SetNotes sets the notes property value. The notes property
func (m *OrdersItemItemsPostResponse) SetNotes(value *string) {
	m.notes = value
}

// SetNumberOfPayments sets the numberOfPayments property value. The numberOfPayments property
func (m *OrdersItemItemsPostResponse) SetNumberOfPayments(value *int32) {
	m.numberOfPayments = value
}

// SetOrderItemTaxes sets the orderItemTaxes property value. The orderItemTaxes property
func (m *OrdersItemItemsPostResponse) SetOrderItemTaxes(value []OrdersItemItemsPostResponse_orderItemTaxesable) {
	m.orderItemTaxes = value
}

// SetPrice sets the price property value. The price property
func (m *OrdersItemItemsPostResponse) SetPrice(value *float64) {
	m.price = value
}

// SetProduct sets the product property value. The product property
func (m *OrdersItemItemsPostResponse) SetProduct(value OrdersItemItemsPostResponse_productable) {
	m.product = value
}

// SetQuantity sets the quantity property value. The quantity property
func (m *OrdersItemItemsPostResponse) SetQuantity(value *int32) {
	m.quantity = value
}

// SetRecurringBilling sets the recurringBilling property value. The recurringBilling property
func (m *OrdersItemItemsPostResponse) SetRecurringBilling(value *bool) {
...
func (m *OrdersItemItemsPostResponse) SetRecurringCyclesCompleted(value *int32) {
...
func (m *OrdersItemItemsPostResponse) SetRecurringEndDate(value *string) {
	m.recurringEndDate = value
}

// SetRecurringInactive sets the recurringInactive property value. The recurringInactive property
func (m *OrdersItemItemsPostResponse) SetRecurringInactive(value *bool) {
...
func (m *OrdersItemItemsPostResponse) SetRecurringNextBillDate(value *string) {
...
func (m *OrdersItemItemsPostResponse) SetRecurringStartDate(value *string) {
	m.recurringStartDate = value
}

// SetSpecialAmount sets the specialAmount property value. The specialAmount property
func (m *OrdersItemItemsPostResponse) SetSpecialAmount(value *float64) {
	m.specialAmount = value
}

// SetSpecialId sets the specialId property value. The specialId property
func (m *OrdersItemItemsPostResponse) SetSpecialId(value *int64) {
	m.specialId = value
}

// SetSpecialPctOrAmt sets the specialPctOrAmt property value. The specialPctOrAmt property
func (m *OrdersItemItemsPostResponse) SetSpecialPctOrAmt(value *int32) {
	m.specialPctOrAmt = value
}

// SetTypeEscaped sets the type property value. The type property
func (m *OrdersItemItemsPostResponse) SetTypeEscaped(value *string) {
	m.typeEscaped = value
}

type OrdersItemItemsPostResponseable interface {
	...
	GetOrderItemTaxes() []OrdersItemItemsPostResponse_orderItemTaxesable
	GetPrice() *float64
	GetProduct() OrdersItemItemsPostResponse_productable
	GetQuantity() *int32
	...
	SetOrderItemTaxes(value []OrdersItemItemsPostResponse_orderItemTaxesable)
	SetPrice(value *float64)
	SetProduct(value OrdersItemItemsPostResponse_productable)
