...
type TasksItemWithTaskPatchResponse struct {
	...
	contact TasksItemWithTaskPatchResponse_contactable
...
// NewTasksItemWithTaskPatchResponse instantiates a new TasksItemWithTaskPatchResponse and sets the default values.
func NewTasksItemWithTaskPatchResponse() *TasksItemWithTaskPatchResponse {
	m := &TasksItemWithTaskPatchResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateTasksItemWithTaskPatchResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateTasksItemWithTaskPatchResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewTasksItemWithTaskPatchResponse(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *TasksItemWithTaskPatchResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCompleted gets the completed property value. The completed property
// returns a *bool when successful
func (m *TasksItemWithTaskPatchResponse) GetCompleted() *bool {
	return m.completed
}

// GetCompletionDate gets the completion_date property value. The completion_date property
// returns a *Time when successful
func (m *TasksItemWithTaskPatchResponse) GetCompletionDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.completion_date
}

// GetContact gets the contact property value. The contact property
// returns a TasksItemWithTaskPatchResponse_contactable when successful
func (m *TasksItemWithTaskPatchResponse) GetContact() TasksItemWithTaskPatchResponse_contactable {
	return m.contact
}

// GetCreationDate gets the creation_date property value. The creation_date property
// returns a *Time when successful
func (m *TasksItemWithTaskPatchResponse) GetCreationDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.creation_date
}

// GetDescription gets the description property value. The description property
// returns a *string when successful
func (m *TasksItemWithTaskPatchResponse) GetDescription() *string {
	return m.description
}

// GetDueDate gets the due_date property value. The due_date property
// returns a *Time when successful
func (m *TasksItemWithTaskPatchResponse) GetDueDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.due_date
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *TasksItemWithTaskPatchResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateTasksItemWithTaskPatchResponse_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(TasksItemWithTaskPatchResponse_contactable))
		}
		return nil
	}
...
func (m *TasksItemWithTaskPatchResponse) GetFunnelId() *int64 {
	return m.funnel_id
}

// GetJgraphId gets the jgraph_id property value. The jgraph_id property
// returns a *int64 when successful
func (m *TasksItemWithTaskPatchResponse) GetJgraphId() *int64 {
	return m.jgraph_id
}

// GetModificationDate gets the modification_date property value. The modification_date property
// returns a *Time when successful
func (m *TasksItemWithTaskPatchResponse) GetModificationDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.modification_date
}

// GetPriority gets the priority property value. The priority property
// returns a *int32 when successful
func (m *TasksItemWithTaskPatchResponse) GetPriority() *int32 {
	return m.priority
}
...
// returns a *int32 when successful
func (m *TasksItemWithTaskPatchResponse) GetRemindTime() *int32 {
	return m.remind_time
}

// GetTitle gets the title property value. The title property
// returns a *string when successful
func (m *TasksItemWithTaskPatchResponse) GetTitle() *string {
	return m.title
}

// GetTypeEscaped gets the type property value. The type property
// returns a *string when successful
func (m *TasksItemWithTaskPatchResponse) GetTypeEscaped() *string {
	return m.typeEscaped
}

// GetUrl gets the url property value. The url property
// returns a *string when successful
func (m *TasksItemWithTaskPatchResponse) GetUrl() *string {
	return m.url
}

// GetUserId gets the user_id property value. The user_id property
// returns a *int64 when successful
func (m *TasksItemWithTaskPatchResponse) GetUserId() *int64 {
	return m.user_id
}

// Serialize serializes information the current object
func (m *TasksItemWithTaskPatchResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *TasksItemWithTaskPatchResponse) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCompleted sets the completed property value. The completed property
func (m *TasksItemWithTaskPatchResponse) SetCompleted(value *bool) {
	m.completed = value
}

// SetCompletionDate sets the completion_date property value. The completion_date property
func (m *TasksItemWithTaskPatchResponse) SetCompletionDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.completion_date = value
}

// SetContact sets the contact property value. The contact property
func (m *TasksItemWithTaskPatchResponse) SetContact(value TasksItemWithTaskPatchResponse_contactable) {
	m.contact = value
}

// SetCreationDate sets the creation_date property value. The creation_date property
func (m *TasksItemWithTaskPatchResponse) SetCreationDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.creation_date = value
}

// SetDescription sets the description property value. The description property
func (m *TasksItemWithTaskPatchResponse) SetDescription(value *string) {
	m.description = value
}

// SetDueDate sets the due_date property value. The due_date property
func (m *TasksItemWithTaskPatchResponse) SetDueDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.due_date = value
}

// SetFunnelId sets the funnel_id property value. The funnel_id property
func (m *TasksItemWithTaskPatchResponse) SetFunnelId(value *int64) {
	m.funnel_id = value
}

// SetJgraphId sets the jgraph_id property value. The jgraph_id property
func (m *TasksItemWithTaskPatchResponse) SetJgraphId(value *int64) {
	m.jgraph_id = value
}

// SetModificationDate sets the modification_date property value. The modification_date property
func (m *TasksItemWithTaskPatchResponse) SetModificationDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.modification_date = value
}

// SetPriority sets the priority property value. The priority property
func (m *TasksItemWithTaskPatchResponse) SetPriority(value *int32) {
	m.priority = value
}
...
func (m *TasksItemWithTaskPatchResponse) SetRemindTime(value *int32) {
	m.remind_time = value
}

// SetTitle sets the title property value. The title property
func (m *TasksItemWithTaskPatchResponse) SetTitle(value *string) {
	m.title = value
}

// SetTypeEscaped sets the type property value. The type property
func (m *TasksItemWithTaskPatchResponse) SetTypeEscaped(value *string) {
	m.typeEscaped = value
}

// SetUrl sets the url property value. The url property
func (m *TasksItemWithTaskPatchResponse) SetUrl(value *string) {
	m.url = value
}

// SetUserId sets the user_id property value. The user_id property
func (m *TasksItemWithTaskPatchResponse) SetUserId(value *int64) {
	m.user_id = value
}

type TasksItemWithTaskPatchResponseable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetCompleted() *bool
	GetCompletionDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time
	GetContact() TasksItemWithTaskPatchResponse_contactable
	...
	SetContact(value TasksItemWithTaskPatchResponse_contactable)
