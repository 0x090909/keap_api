...
type OrdersItemWithOrderGetResponse struct {
	...
	contact OrdersItemWithOrderGetResponse_contactable
	...
	order_items []OrdersItemWithOrderGetResponse_order_itemsable
	// The payment_plan property
	payment_plan OrdersItemWithOrderGetResponse_payment_planable
	...
	shipping_information OrdersItemWithOrderGetResponse_shipping_informationable
	// The status property
	status *string
	// The terms property
	terms *string
...
// NewOrdersItemWithOrderGetResponse instantiates a new OrdersItemWithOrderGetResponse and sets the default values.
func NewOrdersItemWithOrderGetResponse() *OrdersItemWithOrderGetResponse {
	m := &OrdersItemWithOrderGetResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOrdersItemWithOrderGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOrdersItemWithOrderGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOrdersItemWithOrderGetResponse(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OrdersItemWithOrderGetResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAllowPayment gets the allow_payment property value. The allow_payment property
// returns a *bool when successful
func (m *OrdersItemWithOrderGetResponse) GetAllowPayment() *bool {
	return m.allow_payment
}

// GetAllowPaypal gets the allow_paypal property value. The allow_paypal property
// returns a *bool when successful
func (m *OrdersItemWithOrderGetResponse) GetAllowPaypal() *bool {
	return m.allow_paypal
}

// GetContact gets the contact property value. The contact property
// returns a OrdersItemWithOrderGetResponse_contactable when successful
func (m *OrdersItemWithOrderGetResponse) GetContact() OrdersItemWithOrderGetResponse_contactable {
	return m.contact
}

// GetCreationDate gets the creation_date property value. The creation_date property
// returns a *string when successful
func (m *OrdersItemWithOrderGetResponse) GetCreationDate() *string {
	return m.creation_date
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OrdersItemWithOrderGetResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOrdersItemWithOrderGetResponse_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(OrdersItemWithOrderGetResponse_contactable))
		}
		return nil
	}
	...
	res["order_items"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateOrdersItemWithOrderGetResponse_order_itemsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]OrdersItemWithOrderGetResponse_order_itemsable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(OrdersItemWithOrderGetResponse_order_itemsable)
				}
			}
			m.SetOrderItems(res)
		}
	...
	res["payment_plan"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOrdersItemWithOrderGetResponse_payment_planFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetPaymentPlan(val.(OrdersItemWithOrderGetResponse_payment_planable))
		}
		return nil
	}
	...
	res["shipping_information"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOrdersItemWithOrderGetResponse_shipping_informationFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetShippingInformation(val.(OrdersItemWithOrderGetResponse_shipping_informationable))
		}
		return nil
	}
...
// returns a OrdersItemWithOrderGetResponse_shipping_informationable when successful
func (m *OrdersItemWithOrderGetResponse) GetShippingInformation() OrdersItemWithOrderGetResponse_shipping_informationable {
	return m.shipping_information
}

// GetStatus gets the status property value. The status property
// returns a *string when successful
func (m *OrdersItemWithOrderGetResponse) GetStatus() *string {
	return m.status
}

// GetTerms gets the terms property value. The terms property
// returns a *string when successful
func (m *OrdersItemWithOrderGetResponse) GetTerms() *string {
	return m.terms
}

// GetTitle gets the title property value. The title property
// returns a *string when successful
func (m *OrdersItemWithOrderGetResponse) GetTitle() *string {
	return m.title
}

// GetTotal gets the total property value. The total property
// returns a *float64 when successful
func (m *OrdersItemWithOrderGetResponse) GetTotal() *float64 {
	return m.total
}

// GetTotalDue gets the total_due property value. The total_due property
// returns a *float64 when successful
func (m *OrdersItemWithOrderGetResponse) GetTotalDue() *float64 {
	return m.total_due
}

// GetTotalPaid gets the total_paid property value. The total_paid property
// returns a *float64 when successful
func (m *OrdersItemWithOrderGetResponse) GetTotalPaid() *float64 {
	return m.total_paid
}

// Serialize serializes information the current object
func (m *OrdersItemWithOrderGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *OrdersItemWithOrderGetResponse) SetShippingInformation(value OrdersItemWithOrderGetResponse_shipping_informationable) {
	m.shipping_information = value
}

// SetStatus sets the status property value. The status property
func (m *OrdersItemWithOrderGetResponse) SetStatus(value *string) {
	m.status = value
}

// SetTerms sets the terms property value. The terms property
func (m *OrdersItemWithOrderGetResponse) SetTerms(value *string) {
	m.terms = value
}

// SetTitle sets the title property value. The title property
func (m *OrdersItemWithOrderGetResponse) SetTitle(value *string) {
	m.title = value
}

// SetTotal sets the total property value. The total property
func (m *OrdersItemWithOrderGetResponse) SetTotal(value *float64) {
	m.total = value
}

// SetTotalDue sets the total_due property value. The total_due property
func (m *OrdersItemWithOrderGetResponse) SetTotalDue(value *float64) {
	m.total_due = value
}

// SetTotalPaid sets the total_paid property value. The total_paid property
func (m *OrdersItemWithOrderGetResponse) SetTotalPaid(value *float64) {
	m.total_paid = value
}

type OrdersItemWithOrderGetResponseable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAllowPayment() *bool
	GetAllowPaypal() *bool
	GetContact() OrdersItemWithOrderGetResponse_contactable
	...
	GetNotes() *string
	GetOrderDate() *string
	GetOrderItems() []OrdersItemWithOrderGetResponse_order_itemsable
	GetPaymentPlan() OrdersItemWithOrderGetResponse_payment_planable
	GetRecurring() *bool
	GetRefundTotal() *float64
	GetSalesAffiliateId() *int64
	GetShippingInformation() OrdersItemWithOrderGetResponse_shipping_informationable
	GetStatus() *string
	GetTerms() *string
	GetTitle() *string
	GetTotal() *float64
	...
	SetContact(value OrdersItemWithOrderGetResponse_contactable)
	...
	SetOrderItems(value []OrdersItemWithOrderGetResponse_order_itemsable)
	SetPaymentPlan(value OrdersItemWithOrderGetResponse_payment_planable)
	SetRecurring(value *bool)
	SetRefundTotal(value *float64)
	SetSalesAffiliateId(value *int64)
	SetShippingInformation(value OrdersItemWithOrderGetResponse_shipping_informationable)
