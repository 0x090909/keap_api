...
type ProductsGetResponse_products struct {
	...
	product_options []ProductsGetResponse_products_product_optionsable
	...
	subscription_plans []ProductsGetResponse_products_subscription_plansable
	// The url property
	url *string
}

// NewProductsGetResponse_products instantiates a new ProductsGetResponse_products and sets the default values.
func NewProductsGetResponse_products() *ProductsGetResponse_products {
	m := &ProductsGetResponse_products{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateProductsGetResponse_productsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateProductsGetResponse_productsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewProductsGetResponse_products(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ProductsGetResponse_products) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ProductsGetResponse_products) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["product_options"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateProductsGetResponse_products_product_optionsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]ProductsGetResponse_products_product_optionsable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(ProductsGetResponse_products_product_optionsable)
				}
			}
	...
	res["subscription_plans"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateProductsGetResponse_products_subscription_plansFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]ProductsGetResponse_products_subscription_plansable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(ProductsGetResponse_products_subscription_plansable)
				}
			}
...
// returns a []ProductsGetResponse_products_subscription_plansable when successful
func (m *ProductsGetResponse_products) GetSubscriptionPlans() []ProductsGetResponse_products_subscription_plansable {
	return m.subscription_plans
}

// GetUrl gets the url property value. The url property
// returns a *string when successful
func (m *ProductsGetResponse_products) GetUrl() *string {
	return m.url
}

// Serialize serializes information the current object
func (m *ProductsGetResponse_products) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ProductsGetResponse_products) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetId sets the id property value. The id property
func (m *ProductsGetResponse_products) SetId(value *int64) {
	m.id = value
}

// SetProductDesc sets the product_desc property value. The product_desc property
func (m *ProductsGetResponse_products) SetProductDesc(value *string) {
	m.product_desc = value
}

// SetProductName sets the product_name property value. The product_name property
func (m *ProductsGetResponse_products) SetProductName(value *string) {
	m.product_name = value
}

// SetProductOptions sets the product_options property value. The product_options property
func (m *ProductsGetResponse_products) SetProductOptions(value []ProductsGetResponse_products_product_optionsable) {
	m.product_options = value
}

// SetProductPrice sets the product_price property value. The product_price property
func (m *ProductsGetResponse_products) SetProductPrice(value *float64) {
	m.product_price = value
}

// SetProductShortDesc sets the product_short_desc property value. The product_short_desc property
func (m *ProductsGetResponse_products) SetProductShortDesc(value *string) {
	m.product_short_desc = value
}

// SetSku sets the sku property value. The sku property
func (m *ProductsGetResponse_products) SetSku(value *string) {
	m.sku = value
}

// SetStatus sets the status property value. The status property
func (m *ProductsGetResponse_products) SetStatus(value *int32) {
	m.status = value
}

// SetSubscriptionOnly sets the subscription_only property value. The subscription_only property
func (m *ProductsGetResponse_products) SetSubscriptionOnly(value *bool) {
	m.subscription_only = value
}

// SetSubscriptionPlans sets the subscription_plans property value. The subscription_plans property
func (m *ProductsGetResponse_products) SetSubscriptionPlans(value []ProductsGetResponse_products_subscription_plansable) {
	m.subscription_plans = value
}

// SetUrl sets the url property value. The url property
func (m *ProductsGetResponse_products) SetUrl(value *string) {
	m.url = value
}

type ProductsGetResponse_productsable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetId() *int64
	GetProductDesc() *string
	GetProductName() *string
	GetProductOptions() []ProductsGetResponse_products_product_optionsable
	GetProductPrice() *float64
	GetProductShortDesc() *string
	GetSku() *string
	GetStatus() *int32
	GetSubscriptionOnly() *bool
	GetSubscriptionPlans() []ProductsGetResponse_products_subscription_plansable
	GetUrl() *string
	SetId(value *int64)
	SetProductDesc(value *string)
	SetProductName(value *string)
	SetProductOptions(value []ProductsGetResponse_products_product_optionsable)
	SetProductPrice(value *float64)
	SetProductShortDesc(value *string)
	SetSku(value *string)
	SetStatus(value *int32)
	SetSubscriptionOnly(value *bool)
	SetSubscriptionPlans(value []ProductsGetResponse_products_subscription_plansable)
	SetUrl(value *string)
}
