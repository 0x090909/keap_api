...
type OpportunitiesPutRequestBody struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// The affiliate_id property
	affiliate_id *int64
	// The contact property
	contact OpportunitiesPutRequestBody_contactable
	// The custom_fields property
	custom_fields []OpportunitiesPutRequestBody_custom_fieldsable
	...
	// The stage property
	stage OpportunitiesPutRequestBody_stageable
	// The user property
	user OpportunitiesPutRequestBody_userable
}

// NewOpportunitiesPutRequestBody instantiates a new OpportunitiesPutRequestBody and sets the default values.
func NewOpportunitiesPutRequestBody() *OpportunitiesPutRequestBody {
	m := &OpportunitiesPutRequestBody{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOpportunitiesPutRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOpportunitiesPutRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOpportunitiesPutRequestBody(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OpportunitiesPutRequestBody) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAffiliateId gets the affiliate_id property value. The affiliate_id property
// returns a *int64 when successful
func (m *OpportunitiesPutRequestBody) GetAffiliateId() *int64 {
	return m.affiliate_id
}

// GetContact gets the contact property value. The contact property
// returns a OpportunitiesPutRequestBody_contactable when successful
func (m *OpportunitiesPutRequestBody) GetContact() OpportunitiesPutRequestBody_contactable {
	return m.contact
}

// GetCustomFields gets the custom_fields property value. The custom_fields property
// returns a []OpportunitiesPutRequestBody_custom_fieldsable when successful
func (m *OpportunitiesPutRequestBody) GetCustomFields() []OpportunitiesPutRequestBody_custom_fieldsable {
	return m.custom_fields
}

// GetDateCreated gets the date_created property value. The date_created property
// returns a *Time when successful
func (m *OpportunitiesPutRequestBody) GetDateCreated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
func (m *OpportunitiesPutRequestBody) GetEstimatedCloseDate() *string {
	return m.estimated_close_date
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OpportunitiesPutRequestBody) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesPutRequestBody_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(OpportunitiesPutRequestBody_contactable))
		}
		return nil
	}
	res["custom_fields"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateOpportunitiesPutRequestBody_custom_fieldsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]OpportunitiesPutRequestBody_custom_fieldsable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(OpportunitiesPutRequestBody_custom_fieldsable)
				}
			}
	...
	res["stage"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesPutRequestBody_stageFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetStage(val.(OpportunitiesPutRequestBody_stageable))
		}
		return nil
	}
	res["user"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesPutRequestBody_userFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetUser(val.(OpportunitiesPutRequestBody_userable))
		}
		return nil
	}
	return res
...
func (m *OpportunitiesPutRequestBody) GetProjectedRevenueHigh() *float64 {
...
// returns a *float64 when successful
func (m *OpportunitiesPutRequestBody) GetProjectedRevenueLow() *float64 {
	return m.projected_revenue_low
}

// GetStage gets the stage property value. The stage property
// returns a OpportunitiesPutRequestBody_stageable when successful
func (m *OpportunitiesPutRequestBody) GetStage() OpportunitiesPutRequestBody_stageable {
	return m.stage
}

// GetUser gets the user property value. The user property
// returns a OpportunitiesPutRequestBody_userable when successful
func (m *OpportunitiesPutRequestBody) GetUser() OpportunitiesPutRequestBody_userable {
	return m.user
}

// Serialize serializes information the current object
func (m *OpportunitiesPutRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *OpportunitiesPutRequestBody) SetProjectedRevenueHigh(value *float64) {
...
func (m *OpportunitiesPutRequestBody) SetProjectedRevenueLow(value *float64) {
	m.projected_revenue_low = value
}

// SetStage sets the stage property value. The stage property
func (m *OpportunitiesPutRequestBody) SetStage(value OpportunitiesPutRequestBody_stageable) {
	m.stage = value
}

// SetUser sets the user property value. The user property
func (m *OpportunitiesPutRequestBody) SetUser(value OpportunitiesPutRequestBody_userable) {
	m.user = value
}

type OpportunitiesPutRequestBodyable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAffiliateId() *int64
	GetContact() OpportunitiesPutRequestBody_contactable
	GetCustomFields() []OpportunitiesPutRequestBody_custom_fieldsable
	...
	GetStage() OpportunitiesPutRequestBody_stageable
	GetUser() OpportunitiesPutRequestBody_userable
	SetAffiliateId(value *int64)
	SetContact(value OpportunitiesPutRequestBody_contactable)
	SetCustomFields(value []OpportunitiesPutRequestBody_custom_fieldsable)
	...
	SetStage(value OpportunitiesPutRequestBody_stageable)
	SetUser(value OpportunitiesPutRequestBody_userable)
}
