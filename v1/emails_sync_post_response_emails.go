...
type EmailsSyncPostResponse_emails struct {
...
// NewEmailsSyncPostResponse_emails instantiates a new EmailsSyncPostResponse_emails and sets the default values.
func NewEmailsSyncPostResponse_emails() *EmailsSyncPostResponse_emails {
	m := &EmailsSyncPostResponse_emails{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateEmailsSyncPostResponse_emailsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateEmailsSyncPostResponse_emailsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewEmailsSyncPostResponse_emails(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *EmailsSyncPostResponse_emails) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetClickedDate gets the clicked_date property value. The clicked_date property
// returns a *Time when successful
func (m *EmailsSyncPostResponse_emails) GetClickedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.clicked_date
}

// GetContactId gets the contact_id property value. The contact_id property
// returns a *int64 when successful
func (m *EmailsSyncPostResponse_emails) GetContactId() *int64 {
	return m.contact_id
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *EmailsSyncPostResponse_emails) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *EmailsSyncPostResponse_emails) GetHeaders() *string {
	return m.headers
}

// GetHtmlContent gets the html_content property value. Base64 encoded HTML
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetHtmlContent() *string {
	return m.html_content
}

// GetId gets the id property value. The id property
// returns a *int64 when successful
func (m *EmailsSyncPostResponse_emails) GetId() *int64 {
	return m.id
}

// GetOpenedDate gets the opened_date property value. The opened_date property
// returns a *Time when successful
func (m *EmailsSyncPostResponse_emails) GetOpenedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetOriginalProviderId() *string {
	return m.original_provider_id
}

// GetPlainContent gets the plain_content property value. Base64 encoded text
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetPlainContent() *string {
...
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetProviderSourceId() *string {
	return m.provider_source_id
}

// GetReceivedDate gets the received_date property value. The received_date property
// returns a *Time when successful
func (m *EmailsSyncPostResponse_emails) GetReceivedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.received_date
}

// GetSentDate gets the sent_date property value. The sent_date property
// returns a *Time when successful
func (m *EmailsSyncPostResponse_emails) GetSentDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.sent_date
}

// GetSentFromAddress gets the sent_from_address property value. The sent_from_address property
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetSentFromAddress() *string {
...
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetSentFromReplyAddress() *string {
	return m.sent_from_reply_address
}

// GetSentToAddress gets the sent_to_address property value. The sent_to_address property
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetSentToAddress() *string {
...
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetSentToBccAddresses() *string {
...
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetSentToCcAddresses() *string {
	return m.sent_to_cc_addresses
}

// GetSubject gets the subject property value. The subject property
// returns a *string when successful
func (m *EmailsSyncPostResponse_emails) GetSubject() *string {
	return m.subject
}

// Serialize serializes information the current object
func (m *EmailsSyncPostResponse_emails) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *EmailsSyncPostResponse_emails) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetClickedDate sets the clicked_date property value. The clicked_date property
func (m *EmailsSyncPostResponse_emails) SetClickedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.clicked_date = value
}

// SetContactId sets the contact_id property value. The contact_id property
func (m *EmailsSyncPostResponse_emails) SetContactId(value *int64) {
	m.contact_id = value
}

// SetHeaders sets the headers property value. The headers property
func (m *EmailsSyncPostResponse_emails) SetHeaders(value *string) {
	m.headers = value
}

// SetHtmlContent sets the html_content property value. Base64 encoded HTML
func (m *EmailsSyncPostResponse_emails) SetHtmlContent(value *string) {
	m.html_content = value
}

// SetId sets the id property value. The id property
func (m *EmailsSyncPostResponse_emails) SetId(value *int64) {
	m.id = value
}

// SetOpenedDate sets the opened_date property value. The opened_date property
func (m *EmailsSyncPostResponse_emails) SetOpenedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.opened_date = value
}
...
func (m *EmailsSyncPostResponse_emails) SetOriginalProviderId(value *string) {
	m.original_provider_id = value
}

// SetPlainContent sets the plain_content property value. Base64 encoded text
func (m *EmailsSyncPostResponse_emails) SetPlainContent(value *string) {
...
func (m *EmailsSyncPostResponse_emails) SetProviderSourceId(value *string) {
	m.provider_source_id = value
}

// SetReceivedDate sets the received_date property value. The received_date property
func (m *EmailsSyncPostResponse_emails) SetReceivedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.received_date = value
}

// SetSentDate sets the sent_date property value. The sent_date property
func (m *EmailsSyncPostResponse_emails) SetSentDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.sent_date = value
}

// SetSentFromAddress sets the sent_from_address property value. The sent_from_address property
func (m *EmailsSyncPostResponse_emails) SetSentFromAddress(value *string) {
...
func (m *EmailsSyncPostResponse_emails) SetSentFromReplyAddress(value *string) {
	m.sent_from_reply_address = value
}

// SetSentToAddress sets the sent_to_address property value. The sent_to_address property
func (m *EmailsSyncPostResponse_emails) SetSentToAddress(value *string) {
...
func (m *EmailsSyncPostResponse_emails) SetSentToBccAddresses(value *string) {
...
func (m *EmailsSyncPostResponse_emails) SetSentToCcAddresses(value *string) {
	m.sent_to_cc_addresses = value
}

// SetSubject sets the subject property value. The subject property
func (m *EmailsSyncPostResponse_emails) SetSubject(value *string) {
	m.subject = value
}

type EmailsSyncPostResponse_emailsable interface {
