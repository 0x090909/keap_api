...
type ProductsPostResponse struct {
	...
	subscription_plans []ProductsPostResponse_subscription_plansable
	// The url property
	url *string
}

// NewProductsPostResponse instantiates a new ProductsPostResponse and sets the default values.
func NewProductsPostResponse() *ProductsPostResponse {
	m := &ProductsPostResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateProductsPostResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateProductsPostResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewProductsPostResponse(), nil
}

// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *ProductsPostResponse) GetActive() *bool {
	return m.active
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ProductsPostResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ProductsPostResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["subscription_plans"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateProductsPostResponse_subscription_plansFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]ProductsPostResponse_subscription_plansable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(ProductsPostResponse_subscription_plansable)
				}
			}
...
// returns a []ProductsPostResponse_subscription_plansable when successful
func (m *ProductsPostResponse) GetSubscriptionPlans() []ProductsPostResponse_subscription_plansable {
	return m.subscription_plans
}

// GetUrl gets the url property value. The url property
// returns a *string when successful
func (m *ProductsPostResponse) GetUrl() *string {
	return m.url
}

// Serialize serializes information the current object
func (m *ProductsPostResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
type ProductsPostResponseable interface {
	...
	GetSubscriptionPlans() []ProductsPostResponse_subscription_plansable
	GetUrl() *string
	...
	SetSubscriptionPlans(value []ProductsPostResponse_subscription_plansable)
	SetUrl(value *string)
}
