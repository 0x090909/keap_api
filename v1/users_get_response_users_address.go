...
type UsersGetResponse_users_address struct {
...
// NewUsersGetResponse_users_address instantiates a new UsersGetResponse_users_address and sets the default values.
func NewUsersGetResponse_users_address() *UsersGetResponse_users_address {
	m := &UsersGetResponse_users_address{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateUsersGetResponse_users_addressFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateUsersGetResponse_users_addressFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewUsersGetResponse_users_address(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *UsersGetResponse_users_address) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCountryCode gets the country_code property value. The country_code property
// returns a *string when successful
func (m *UsersGetResponse_users_address) GetCountryCode() *string {
	return m.country_code
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *UsersGetResponse_users_address) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *UsersGetResponse_users_address) GetLine1() *string {
	return m.line1
}

// GetLine2 gets the line2 property value. The line2 property
// returns a *string when successful
func (m *UsersGetResponse_users_address) GetLine2() *string {
	return m.line2
}

// GetLocality gets the locality property value. The locality property
// returns a *string when successful
func (m *UsersGetResponse_users_address) GetLocality() *string {
	return m.locality
}

// GetRegion gets the region property value. The region property
// returns a *string when successful
func (m *UsersGetResponse_users_address) GetRegion() *string {
	return m.region
}

// GetZipCode gets the zip_code property value. The zip_code property
// returns a *string when successful
func (m *UsersGetResponse_users_address) GetZipCode() *string {
	return m.zip_code
}

// GetZipFour gets the zip_four property value. The zip_four property
// returns a *string when successful
func (m *UsersGetResponse_users_address) GetZipFour() *string {
	return m.zip_four
}

// Serialize serializes information the current object
func (m *UsersGetResponse_users_address) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *UsersGetResponse_users_address) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCountryCode sets the country_code property value. The country_code property
func (m *UsersGetResponse_users_address) SetCountryCode(value *string) {
	m.country_code = value
}

// SetLine1 sets the line1 property value. The line1 property
func (m *UsersGetResponse_users_address) SetLine1(value *string) {
	m.line1 = value
}

// SetLine2 sets the line2 property value. The line2 property
func (m *UsersGetResponse_users_address) SetLine2(value *string) {
	m.line2 = value
}

// SetLocality sets the locality property value. The locality property
func (m *UsersGetResponse_users_address) SetLocality(value *string) {
	m.locality = value
}

// SetRegion sets the region property value. The region property
func (m *UsersGetResponse_users_address) SetRegion(value *string) {
	m.region = value
}

// SetZipCode sets the zip_code property value. The zip_code property
func (m *UsersGetResponse_users_address) SetZipCode(value *string) {
	m.zip_code = value
}

// SetZipFour sets the zip_four property value. The zip_four property
func (m *UsersGetResponse_users_address) SetZipFour(value *string) {
	m.zip_four = value
}

type UsersGetResponse_users_addressable interface {
