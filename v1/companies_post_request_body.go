...
// returns a *string when successful
func (m *CompaniesPostRequestBody) GetEmailAddress() *string {
...
// returns a *string when successful
func (m *CompaniesPostRequestBody) GetOptInReason() *string {
...
func (m *CompaniesPostRequestBody) SetEmailAddress(value *string) {
...
func (m *CompaniesPostRequestBody) SetOptInReason(value *string) {
