...
type OrdersItemItems403Error_cause_stackTrace struct {
...
// NewOrdersItemItems403Error_cause_stackTrace instantiates a new OrdersItemItems403Error_cause_stackTrace and sets the default values.
func NewOrdersItemItems403Error_cause_stackTrace() *OrdersItemItems403Error_cause_stackTrace {
	m := &OrdersItemItems403Error_cause_stackTrace{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOrdersItemItems403Error_cause_stackTraceFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOrdersItemItems403Error_cause_stackTraceFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOrdersItemItems403Error_cause_stackTrace(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetClassLoaderName gets the classLoaderName property value. The classLoaderName property
// returns a *string when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetClassLoaderName() *string {
	return m.classLoaderName
}

// GetClassName gets the className property value. The className property
// returns a *string when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetClassName() *string {
	return m.className
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetFileName() *string {
	return m.fileName
}

// GetLineNumber gets the lineNumber property value. The lineNumber property
// returns a *int32 when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetLineNumber() *int32 {
	return m.lineNumber
}

// GetMethodName gets the methodName property value. The methodName property
// returns a *string when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetMethodName() *string {
	return m.methodName
}

// GetModuleName gets the moduleName property value. The moduleName property
// returns a *string when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetModuleName() *string {
	return m.moduleName
}

// GetModuleVersion gets the moduleVersion property value. The moduleVersion property
// returns a *string when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetModuleVersion() *string {
	return m.moduleVersion
}

// GetNativeMethod gets the nativeMethod property value. The nativeMethod property
// returns a *bool when successful
func (m *OrdersItemItems403Error_cause_stackTrace) GetNativeMethod() *bool {
	return m.nativeMethod
}

// Serialize serializes information the current object
func (m *OrdersItemItems403Error_cause_stackTrace) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *OrdersItemItems403Error_cause_stackTrace) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetClassLoaderName sets the classLoaderName property value. The classLoaderName property
func (m *OrdersItemItems403Error_cause_stackTrace) SetClassLoaderName(value *string) {
	m.classLoaderName = value
}

// SetClassName sets the className property value. The className property
func (m *OrdersItemItems403Error_cause_stackTrace) SetClassName(value *string) {
	m.className = value
}

// SetFileName sets the fileName property value. The fileName property
func (m *OrdersItemItems403Error_cause_stackTrace) SetFileName(value *string) {
	m.fileName = value
}

// SetLineNumber sets the lineNumber property value. The lineNumber property
func (m *OrdersItemItems403Error_cause_stackTrace) SetLineNumber(value *int32) {
	m.lineNumber = value
}

// SetMethodName sets the methodName property value. The methodName property
func (m *OrdersItemItems403Error_cause_stackTrace) SetMethodName(value *string) {
	m.methodName = value
}

// SetModuleName sets the moduleName property value. The moduleName property
func (m *OrdersItemItems403Error_cause_stackTrace) SetModuleName(value *string) {
	m.moduleName = value
}

// SetModuleVersion sets the moduleVersion property value. The moduleVersion property
func (m *OrdersItemItems403Error_cause_stackTrace) SetModuleVersion(value *string) {
	m.moduleVersion = value
}

// SetNativeMethod sets the nativeMethod property value. The nativeMethod property
func (m *OrdersItemItems403Error_cause_stackTrace) SetNativeMethod(value *bool) {
	m.nativeMethod = value
}

type OrdersItemItems403Error_cause_stackTraceable interface {
