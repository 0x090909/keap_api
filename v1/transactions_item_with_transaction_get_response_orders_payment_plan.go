...
type TransactionsItemWithTransactionGetResponse_orders_payment_plan struct {
	...
	payment_gateway TransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayable
	// The plan_start_date property
	plan_start_date *string
}

// NewTransactionsItemWithTransactionGetResponse_orders_payment_plan instantiates a new TransactionsItemWithTransactionGetResponse_orders_payment_plan and sets the default values.
func NewTransactionsItemWithTransactionGetResponse_orders_payment_plan() *TransactionsItemWithTransactionGetResponse_orders_payment_plan {
	m := &TransactionsItemWithTransactionGetResponse_orders_payment_plan{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateTransactionsItemWithTransactionGetResponse_orders_payment_planFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateTransactionsItemWithTransactionGetResponse_orders_payment_planFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewTransactionsItemWithTransactionGetResponse_orders_payment_plan(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAutoCharge gets the auto_charge property value. The auto_charge property
// returns a *bool when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetAutoCharge() *bool {
	return m.auto_charge
}

// GetCreditCardId gets the credit_card_id property value. The credit_card_id property
// returns a *int64 when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetCreditCardId() *int64 {
...
// returns a *int64 when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetDaysBetweenPayments() *int64 {
	return m.days_between_payments
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["payment_gateway"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateTransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetPaymentGateway(val.(TransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayable))
		}
		return nil
	}
...
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetInitialPaymentAmount() *float64 {
...
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetInitialPaymentDate() *string {
...
// returns a *int64 when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetNumberOfPayments() *int64 {
	return m.number_of_payments
}

// GetPaymentGateway gets the payment_gateway property value. The payment_gateway property
// returns a TransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayable when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetPaymentGateway() TransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayable {
	return m.payment_gateway
}

// GetPlanStartDate gets the plan_start_date property value. The plan_start_date property
// returns a *string when successful
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) GetPlanStartDate() *string {
	return m.plan_start_date
}

// Serialize serializes information the current object
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetAutoCharge sets the auto_charge property value. The auto_charge property
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetAutoCharge(value *bool) {
	m.auto_charge = value
}

// SetCreditCardId sets the credit_card_id property value. The credit_card_id property
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetCreditCardId(value *int64) {
...
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetDaysBetweenPayments(value *int64) {
...
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetInitialPaymentAmount(value *float64) {
...
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetInitialPaymentDate(value *string) {
...
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetNumberOfPayments(value *int64) {
	m.number_of_payments = value
}

// SetPaymentGateway sets the payment_gateway property value. The payment_gateway property
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetPaymentGateway(value TransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayable) {
	m.payment_gateway = value
}

// SetPlanStartDate sets the plan_start_date property value. The plan_start_date property
func (m *TransactionsItemWithTransactionGetResponse_orders_payment_plan) SetPlanStartDate(value *string) {
	m.plan_start_date = value
}

type TransactionsItemWithTransactionGetResponse_orders_payment_planable interface {
	...
	GetPaymentGateway() TransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayable
	...
	SetPaymentGateway(value TransactionsItemWithTransactionGetResponse_orders_payment_plan_payment_gatewayable)
