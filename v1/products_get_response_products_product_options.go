...
type ProductsGetResponse_products_product_options struct {
	...
	text_message *string
	// The values property
	values []ProductsGetResponse_products_product_options_valuesable
}

// NewProductsGetResponse_products_product_options instantiates a new ProductsGetResponse_products_product_options and sets the default values.
func NewProductsGetResponse_products_product_options() *ProductsGetResponse_products_product_options {
	m := &ProductsGetResponse_products_product_options{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateProductsGetResponse_products_product_optionsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateProductsGetResponse_products_product_optionsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewProductsGetResponse_products_product_options(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ProductsGetResponse_products_product_options) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAllowSpaces gets the allow_spaces property value. The allow_spaces property
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetAllowSpaces() *bool {
...
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetCanContainCharacter() *bool {
...
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetCanContainNumber() *bool {
...
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetCanEndWithCharacter() *bool {
...
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetCanEndWithNumber() *bool {
...
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetCanStartWithCharacter() *bool {
...
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetCanStartWithNumber() *bool {
	return m.can_start_with_number
}

// GetDisplayIndex gets the display_index property value. The display_index property
// returns a *int32 when successful
func (m *ProductsGetResponse_products_product_options) GetDisplayIndex() *int32 {
	return m.display_index
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ProductsGetResponse_products_product_options) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["values"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateProductsGetResponse_products_product_options_valuesFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]ProductsGetResponse_products_product_options_valuesable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(ProductsGetResponse_products_product_options_valuesable)
				}
			}
			m.SetValues(res)
		}
...
func (m *ProductsGetResponse_products_product_options) GetId() *int64 {
	return m.id
}

// GetLabel gets the label property value. The label property
// returns a *string when successful
func (m *ProductsGetResponse_products_product_options) GetLabel() *string {
	return m.label
}

// GetMaxChars gets the max_chars property value. The max_chars property
// returns a *int32 when successful
func (m *ProductsGetResponse_products_product_options) GetMaxChars() *int32 {
	return m.max_chars
}

// GetMinChars gets the min_chars property value. The min_chars property
// returns a *int32 when successful
func (m *ProductsGetResponse_products_product_options) GetMinChars() *int32 {
	return m.min_chars
}

// GetName gets the name property value. The name property
// returns a *string when successful
func (m *ProductsGetResponse_products_product_options) GetName() *string {
	return m.name
}

// GetRequired gets the required property value. The required property
// returns a *bool when successful
func (m *ProductsGetResponse_products_product_options) GetRequired() *bool {
	return m.required
}

// GetTextMessage gets the text_message property value. The text_message property
// returns a *string when successful
func (m *ProductsGetResponse_products_product_options) GetTextMessage() *string {
	return m.text_message
}

// GetValues gets the values property value. The values property
// returns a []ProductsGetResponse_products_product_options_valuesable when successful
func (m *ProductsGetResponse_products_product_options) GetValues() []ProductsGetResponse_products_product_options_valuesable {
	return m.values
}

// Serialize serializes information the current object
func (m *ProductsGetResponse_products_product_options) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ProductsGetResponse_products_product_options) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetAllowSpaces sets the allow_spaces property value. The allow_spaces property
func (m *ProductsGetResponse_products_product_options) SetAllowSpaces(value *bool) {
...
func (m *ProductsGetResponse_products_product_options) SetCanContainCharacter(value *bool) {
...
func (m *ProductsGetResponse_products_product_options) SetCanContainNumber(value *bool) {
...
func (m *ProductsGetResponse_products_product_options) SetCanEndWithCharacter(value *bool) {
...
func (m *ProductsGetResponse_products_product_options) SetCanEndWithNumber(value *bool) {
...
func (m *ProductsGetResponse_products_product_options) SetCanStartWithCharacter(value *bool) {
...
func (m *ProductsGetResponse_products_product_options) SetCanStartWithNumber(value *bool) {
	m.can_start_with_number = value
}

// SetDisplayIndex sets the display_index property value. The display_index property
func (m *ProductsGetResponse_products_product_options) SetDisplayIndex(value *int32) {
	m.display_index = value
}

// SetId sets the id property value. The id property
func (m *ProductsGetResponse_products_product_options) SetId(value *int64) {
	m.id = value
}

// SetLabel sets the label property value. The label property
func (m *ProductsGetResponse_products_product_options) SetLabel(value *string) {
	m.label = value
}

// SetMaxChars sets the max_chars property value. The max_chars property
func (m *ProductsGetResponse_products_product_options) SetMaxChars(value *int32) {
	m.max_chars = value
}

// SetMinChars sets the min_chars property value. The min_chars property
func (m *ProductsGetResponse_products_product_options) SetMinChars(value *int32) {
	m.min_chars = value
}

// SetName sets the name property value. The name property
func (m *ProductsGetResponse_products_product_options) SetName(value *string) {
	m.name = value
}

// SetRequired sets the required property value. The required property
func (m *ProductsGetResponse_products_product_options) SetRequired(value *bool) {
	m.required = value
}

// SetTextMessage sets the text_message property value. The text_message property
func (m *ProductsGetResponse_products_product_options) SetTextMessage(value *string) {
	m.text_message = value
}

// SetValues sets the values property value. The values property
func (m *ProductsGetResponse_products_product_options) SetValues(value []ProductsGetResponse_products_product_options_valuesable) {
	m.values = value
}

type ProductsGetResponse_products_product_optionsable interface {
	...
	GetValues() []ProductsGetResponse_products_product_options_valuesable
	...
	SetValues(value []ProductsGetResponse_products_product_options_valuesable)
}
