...
// returns a *int64 when successful
func (m *SubscriptionsPostResponse) GetCreditCardId() *int64 {
...
// returns a *bool when successful
func (m *SubscriptionsPostResponse) GetUseDefaultPaymentGateway() *bool {
...
func (m *SubscriptionsPostResponse) SetCreditCardId(value *int64) {
...
func (m *SubscriptionsPostResponse) SetUseDefaultPaymentGateway(value *bool) {
