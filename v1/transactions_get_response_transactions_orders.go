...
type TransactionsGetResponse_transactions_orders struct {
	...
	contact TransactionsGetResponse_transactions_orders_contactable
	...
	order_items []TransactionsGetResponse_transactions_orders_order_itemsable
	// The payment_plan property
	payment_plan TransactionsGetResponse_transactions_orders_payment_planable
	...
	shipping_information TransactionsGetResponse_transactions_orders_shipping_informationable
	// The status property
	status *string
	// The terms property
	terms *string
...
// NewTransactionsGetResponse_transactions_orders instantiates a new TransactionsGetResponse_transactions_orders and sets the default values.
func NewTransactionsGetResponse_transactions_orders() *TransactionsGetResponse_transactions_orders {
	m := &TransactionsGetResponse_transactions_orders{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateTransactionsGetResponse_transactions_ordersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateTransactionsGetResponse_transactions_ordersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewTransactionsGetResponse_transactions_orders(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *TransactionsGetResponse_transactions_orders) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAllowPayment gets the allow_payment property value. The allow_payment property
// returns a *bool when successful
func (m *TransactionsGetResponse_transactions_orders) GetAllowPayment() *bool {
	return m.allow_payment
}

// GetAllowPaypal gets the allow_paypal property value. The allow_paypal property
// returns a *bool when successful
func (m *TransactionsGetResponse_transactions_orders) GetAllowPaypal() *bool {
	return m.allow_paypal
}

// GetContact gets the contact property value. The contact property
// returns a TransactionsGetResponse_transactions_orders_contactable when successful
func (m *TransactionsGetResponse_transactions_orders) GetContact() TransactionsGetResponse_transactions_orders_contactable {
	return m.contact
}

// GetCreationDate gets the creation_date property value. The creation_date property
// returns a *string when successful
func (m *TransactionsGetResponse_transactions_orders) GetCreationDate() *string {
	return m.creation_date
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *TransactionsGetResponse_transactions_orders) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateTransactionsGetResponse_transactions_orders_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(TransactionsGetResponse_transactions_orders_contactable))
		}
		return nil
	}
	...
	res["order_items"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateTransactionsGetResponse_transactions_orders_order_itemsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]TransactionsGetResponse_transactions_orders_order_itemsable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(TransactionsGetResponse_transactions_orders_order_itemsable)
				}
			}
			m.SetOrderItems(res)
		}
	...
	res["payment_plan"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateTransactionsGetResponse_transactions_orders_payment_planFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetPaymentPlan(val.(TransactionsGetResponse_transactions_orders_payment_planable))
		}
		return nil
	}
	...
	res["shipping_information"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateTransactionsGetResponse_transactions_orders_shipping_informationFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetShippingInformation(val.(TransactionsGetResponse_transactions_orders_shipping_informationable))
		}
		return nil
	}
...
func (m *TransactionsGetResponse_transactions_orders) GetId() *int64 {
	return m.id
}

// GetInvoiceNumber gets the invoice_number property value. The invoice_number property
// returns a *int64 when successful
func (m *TransactionsGetResponse_transactions_orders) GetInvoiceNumber() *int64 {
	return m.invoice_number
}

// GetLeadAffiliateId gets the lead_affiliate_id property value. The lead_affiliate_id property
// returns a *int64 when successful
func (m *TransactionsGetResponse_transactions_orders) GetLeadAffiliateId() *int64 {
	return m.lead_affiliate_id
}

// GetModificationDate gets the modification_date property value. The modification_date property
// returns a *string when successful
func (m *TransactionsGetResponse_transactions_orders) GetModificationDate() *string {
	return m.modification_date
}

// GetNotes gets the notes property value. The notes property
// returns a *string when successful
func (m *TransactionsGetResponse_transactions_orders) GetNotes() *string {
	return m.notes
}

// GetOrderDate gets the order_date property value. The order_date property
// returns a *string when successful
func (m *TransactionsGetResponse_transactions_orders) GetOrderDate() *string {
	return m.order_date
}

// GetOrderItems gets the order_items property value. The order_items property
// returns a []TransactionsGetResponse_transactions_orders_order_itemsable when successful
func (m *TransactionsGetResponse_transactions_orders) GetOrderItems() []TransactionsGetResponse_transactions_orders_order_itemsable {
	return m.order_items
}

// GetPaymentPlan gets the payment_plan property value. The payment_plan property
// returns a TransactionsGetResponse_transactions_orders_payment_planable when successful
func (m *TransactionsGetResponse_transactions_orders) GetPaymentPlan() TransactionsGetResponse_transactions_orders_payment_planable {
	return m.payment_plan
}

// GetRecurring gets the recurring property value. The recurring property
// returns a *bool when successful
func (m *TransactionsGetResponse_transactions_orders) GetRecurring() *bool {
	return m.recurring
}

// GetRefundTotal gets the refund_total property value. The refund_total property
// returns a *float64 when successful
func (m *TransactionsGetResponse_transactions_orders) GetRefundTotal() *float64 {
	return m.refund_total
}

// GetSalesAffiliateId gets the sales_affiliate_id property value. The sales_affiliate_id property
// returns a *int64 when successful
func (m *TransactionsGetResponse_transactions_orders) GetSalesAffiliateId() *int64 {
...
// returns a TransactionsGetResponse_transactions_orders_shipping_informationable when successful
func (m *TransactionsGetResponse_transactions_orders) GetShippingInformation() TransactionsGetResponse_transactions_orders_shipping_informationable {
	return m.shipping_information
}

// GetStatus gets the status property value. The status property
// returns a *string when successful
func (m *TransactionsGetResponse_transactions_orders) GetStatus() *string {
	return m.status
}

// GetTerms gets the terms property value. The terms property
// returns a *string when successful
func (m *TransactionsGetResponse_transactions_orders) GetTerms() *string {
	return m.terms
}

// GetTitle gets the title property value. The title property
// returns a *string when successful
func (m *TransactionsGetResponse_transactions_orders) GetTitle() *string {
	return m.title
}

// GetTotal gets the total property value. The total property
// returns a *float64 when successful
func (m *TransactionsGetResponse_transactions_orders) GetTotal() *float64 {
	return m.total
}

// GetTotalDue gets the total_due property value. The total_due property
// returns a *float64 when successful
func (m *TransactionsGetResponse_transactions_orders) GetTotalDue() *float64 {
	return m.total_due
}

// GetTotalPaid gets the total_paid property value. The total_paid property
// returns a *float64 when successful
func (m *TransactionsGetResponse_transactions_orders) GetTotalPaid() *float64 {
	return m.total_paid
}

// Serialize serializes information the current object
func (m *TransactionsGetResponse_transactions_orders) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *TransactionsGetResponse_transactions_orders) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetAllowPayment sets the allow_payment property value. The allow_payment property
func (m *TransactionsGetResponse_transactions_orders) SetAllowPayment(value *bool) {
	m.allow_payment = value
}

// SetAllowPaypal sets the allow_paypal property value. The allow_paypal property
func (m *TransactionsGetResponse_transactions_orders) SetAllowPaypal(value *bool) {
	m.allow_paypal = value
}

// SetContact sets the contact property value. The contact property
func (m *TransactionsGetResponse_transactions_orders) SetContact(value TransactionsGetResponse_transactions_orders_contactable) {
	m.contact = value
}

// SetCreationDate sets the creation_date property value. The creation_date property
func (m *TransactionsGetResponse_transactions_orders) SetCreationDate(value *string) {
	m.creation_date = value
}

// SetId sets the id property value. The id property
func (m *TransactionsGetResponse_transactions_orders) SetId(value *int64) {
	m.id = value
}

// SetInvoiceNumber sets the invoice_number property value. The invoice_number property
func (m *TransactionsGetResponse_transactions_orders) SetInvoiceNumber(value *int64) {
	m.invoice_number = value
}

// SetLeadAffiliateId sets the lead_affiliate_id property value. The lead_affiliate_id property
func (m *TransactionsGetResponse_transactions_orders) SetLeadAffiliateId(value *int64) {
	m.lead_affiliate_id = value
}

// SetModificationDate sets the modification_date property value. The modification_date property
func (m *TransactionsGetResponse_transactions_orders) SetModificationDate(value *string) {
	m.modification_date = value
}

// SetNotes sets the notes property value. The notes property
func (m *TransactionsGetResponse_transactions_orders) SetNotes(value *string) {
	m.notes = value
}

// SetOrderDate sets the order_date property value. The order_date property
func (m *TransactionsGetResponse_transactions_orders) SetOrderDate(value *string) {
	m.order_date = value
}

// SetOrderItems sets the order_items property value. The order_items property
func (m *TransactionsGetResponse_transactions_orders) SetOrderItems(value []TransactionsGetResponse_transactions_orders_order_itemsable) {
	m.order_items = value
}

// SetPaymentPlan sets the payment_plan property value. The payment_plan property
func (m *TransactionsGetResponse_transactions_orders) SetPaymentPlan(value TransactionsGetResponse_transactions_orders_payment_planable) {
	m.payment_plan = value
}

// SetRecurring sets the recurring property value. The recurring property
func (m *TransactionsGetResponse_transactions_orders) SetRecurring(value *bool) {
	m.recurring = value
}

// SetRefundTotal sets the refund_total property value. The refund_total property
func (m *TransactionsGetResponse_transactions_orders) SetRefundTotal(value *float64) {
	m.refund_total = value
}

// SetSalesAffiliateId sets the sales_affiliate_id property value. The sales_affiliate_id property
func (m *TransactionsGetResponse_transactions_orders) SetSalesAffiliateId(value *int64) {
...
func (m *TransactionsGetResponse_transactions_orders) SetShippingInformation(value TransactionsGetResponse_transactions_orders_shipping_informationable) {
	m.shipping_information = value
}

// SetStatus sets the status property value. The status property
func (m *TransactionsGetResponse_transactions_orders) SetStatus(value *string) {
	m.status = value
}

// SetTerms sets the terms property value. The terms property
func (m *TransactionsGetResponse_transactions_orders) SetTerms(value *string) {
	m.terms = value
}

// SetTitle sets the title property value. The title property
func (m *TransactionsGetResponse_transactions_orders) SetTitle(value *string) {
	m.title = value
}

// SetTotal sets the total property value. The total property
func (m *TransactionsGetResponse_transactions_orders) SetTotal(value *float64) {
	m.total = value
}

// SetTotalDue sets the total_due property value. The total_due property
func (m *TransactionsGetResponse_transactions_orders) SetTotalDue(value *float64) {
	m.total_due = value
}

// SetTotalPaid sets the total_paid property value. The total_paid property
func (m *TransactionsGetResponse_transactions_orders) SetTotalPaid(value *float64) {
	m.total_paid = value
}

type TransactionsGetResponse_transactions_ordersable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAllowPayment() *bool
	GetAllowPaypal() *bool
	GetContact() TransactionsGetResponse_transactions_orders_contactable
	...
	GetNotes() *string
	GetOrderDate() *string
	GetOrderItems() []TransactionsGetResponse_transactions_orders_order_itemsable
	GetPaymentPlan() TransactionsGetResponse_transactions_orders_payment_planable
	GetRecurring() *bool
	GetRefundTotal() *float64
	GetSalesAffiliateId() *int64
	GetShippingInformation() TransactionsGetResponse_transactions_orders_shipping_informationable
	GetStatus() *string
	GetTerms() *string
	GetTitle() *string
	GetTotal() *float64
	...
	SetContact(value TransactionsGetResponse_transactions_orders_contactable)
	...
	SetOrderItems(value []TransactionsGetResponse_transactions_orders_order_itemsable)
	SetPaymentPlan(value TransactionsGetResponse_transactions_orders_payment_planable)
	SetRecurring(value *bool)
	SetRefundTotal(value *float64)
	SetSalesAffiliateId(value *int64)
	SetShippingInformation(value TransactionsGetResponse_transactions_orders_shipping_informationable)
