...
type ContactsItemEmailsGetResponse_emails struct {
...
// NewContactsItemEmailsGetResponse_emails instantiates a new ContactsItemEmailsGetResponse_emails and sets the default values.
func NewContactsItemEmailsGetResponse_emails() *ContactsItemEmailsGetResponse_emails {
	m := &ContactsItemEmailsGetResponse_emails{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateContactsItemEmailsGetResponse_emailsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateContactsItemEmailsGetResponse_emailsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewContactsItemEmailsGetResponse_emails(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ContactsItemEmailsGetResponse_emails) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetClickedDate gets the clicked_date property value. The clicked_date property
// returns a *Time when successful
func (m *ContactsItemEmailsGetResponse_emails) GetClickedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.clicked_date
}

// GetContactId gets the contact_id property value. The contact_id property
// returns a *int64 when successful
func (m *ContactsItemEmailsGetResponse_emails) GetContactId() *int64 {
	return m.contact_id
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ContactsItemEmailsGetResponse_emails) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *ContactsItemEmailsGetResponse_emails) GetHeaders() *string {
	return m.headers
}

// GetId gets the id property value. The id property
// returns a *int64 when successful
func (m *ContactsItemEmailsGetResponse_emails) GetId() *int64 {
	return m.id
}

// GetOpenedDate gets the opened_date property value. The opened_date property
// returns a *Time when successful
func (m *ContactsItemEmailsGetResponse_emails) GetOpenedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.opened_date
}

// GetOriginalProviderId gets the original_provider_id property value. The original_provider_id property
// returns a *string when successful
func (m *ContactsItemEmailsGetResponse_emails) GetOriginalProviderId() *string {
	return m.original_provider_id
}

// GetReceivedDate gets the received_date property value. The received_date property
// returns a *Time when successful
func (m *ContactsItemEmailsGetResponse_emails) GetReceivedDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.received_date
}

// GetSentDate gets the sent_date property value. The sent_date property
// returns a *Time when successful
func (m *ContactsItemEmailsGetResponse_emails) GetSentDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.sent_date
}

// GetSentFromAddress gets the sent_from_address property value. The sent_from_address property
// returns a *string when successful
func (m *ContactsItemEmailsGetResponse_emails) GetSentFromAddress() *string {
...
// returns a *string when successful
func (m *ContactsItemEmailsGetResponse_emails) GetSentFromReplyAddress() *string {
	return m.sent_from_reply_address
}

// GetSentToAddress gets the sent_to_address property value. The sent_to_address property
// returns a *string when successful
func (m *ContactsItemEmailsGetResponse_emails) GetSentToAddress() *string {
...
// returns a *string when successful
func (m *ContactsItemEmailsGetResponse_emails) GetSentToBccAddresses() *string {
...
// returns a *string when successful
func (m *ContactsItemEmailsGetResponse_emails) GetSentToCcAddresses() *string {
	return m.sent_to_cc_addresses
}

// GetSubject gets the subject property value. The subject property
// returns a *string when successful
func (m *ContactsItemEmailsGetResponse_emails) GetSubject() *string {
	return m.subject
}

// Serialize serializes information the current object
func (m *ContactsItemEmailsGetResponse_emails) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ContactsItemEmailsGetResponse_emails) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetClickedDate sets the clicked_date property value. The clicked_date property
func (m *ContactsItemEmailsGetResponse_emails) SetClickedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.clicked_date = value
}

// SetContactId sets the contact_id property value. The contact_id property
func (m *ContactsItemEmailsGetResponse_emails) SetContactId(value *int64) {
	m.contact_id = value
}

// SetHeaders sets the headers property value. The headers property
func (m *ContactsItemEmailsGetResponse_emails) SetHeaders(value *string) {
	m.headers = value
}

// SetId sets the id property value. The id property
func (m *ContactsItemEmailsGetResponse_emails) SetId(value *int64) {
	m.id = value
}

// SetOpenedDate sets the opened_date property value. The opened_date property
func (m *ContactsItemEmailsGetResponse_emails) SetOpenedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.opened_date = value
}

// SetOriginalProviderId sets the original_provider_id property value. The original_provider_id property
func (m *ContactsItemEmailsGetResponse_emails) SetOriginalProviderId(value *string) {
	m.original_provider_id = value
}

// SetReceivedDate sets the received_date property value. The received_date property
func (m *ContactsItemEmailsGetResponse_emails) SetReceivedDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.received_date = value
}

// SetSentDate sets the sent_date property value. The sent_date property
func (m *ContactsItemEmailsGetResponse_emails) SetSentDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.sent_date = value
}

// SetSentFromAddress sets the sent_from_address property value. The sent_from_address property
func (m *ContactsItemEmailsGetResponse_emails) SetSentFromAddress(value *string) {
...
func (m *ContactsItemEmailsGetResponse_emails) SetSentFromReplyAddress(value *string) {
	m.sent_from_reply_address = value
}

// SetSentToAddress sets the sent_to_address property value. The sent_to_address property
func (m *ContactsItemEmailsGetResponse_emails) SetSentToAddress(value *string) {
...
func (m *ContactsItemEmailsGetResponse_emails) SetSentToBccAddresses(value *string) {
...
func (m *ContactsItemEmailsGetResponse_emails) SetSentToCcAddresses(value *string) {
	m.sent_to_cc_addresses = value
}

// SetSubject sets the subject property value. The subject property
func (m *ContactsItemEmailsGetResponse_emails) SetSubject(value *string) {
	m.subject = value
}

type ContactsItemEmailsGetResponse_emailsable interface {
