...
type FilesItemWithFileGetResponse_file_descriptor struct {
...
// NewFilesItemWithFileGetResponse_file_descriptor instantiates a new FilesItemWithFileGetResponse_file_descriptor and sets the default values.
func NewFilesItemWithFileGetResponse_file_descriptor() *FilesItemWithFileGetResponse_file_descriptor {
	m := &FilesItemWithFileGetResponse_file_descriptor{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateFilesItemWithFileGetResponse_file_descriptorFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateFilesItemWithFileGetResponse_file_descriptorFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewFilesItemWithFileGetResponse_file_descriptor(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetContactId gets the contact_id property value. The contact_id property
// returns a *int64 when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetContactId() *int64 {
	return m.contact_id
}

// GetCreatedBy gets the created_by property value. The created_by property
// returns a *int64 when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetCreatedBy() *int64 {
	return m.created_by
}

// GetDateCreated gets the date_created property value. The date_created property
// returns a *Time when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetDateCreated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.date_created
}

// GetDownloadUrl gets the download_url property value. The download_url property
// returns a *string when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetDownloadUrl() *string {
	return m.download_url
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetFileName() *string {
	return m.file_name
}

// GetFileSize gets the file_size property value. The file_size property
// returns a *int64 when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetFileSize() *int64 {
	return m.file_size
}

// GetId gets the id property value. The id property
// returns a *int64 when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetId() *int64 {
	return m.id
}

// GetLastUpdated gets the last_updated property value. The last_updated property
// returns a *Time when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetLastUpdated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.last_updated
}

// GetPublic gets the public property value. The public property
// returns a *bool when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetPublic() *bool {
	return m.public
}

// GetRemoteFileKey gets the remote_file_key property value. The remote_file_key property
// returns a *string when successful
func (m *FilesItemWithFileGetResponse_file_descriptor) GetRemoteFileKey() *string {
	return m.remote_file_key
}

// Serialize serializes information the current object
func (m *FilesItemWithFileGetResponse_file_descriptor) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *FilesItemWithFileGetResponse_file_descriptor) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetContactId sets the contact_id property value. The contact_id property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetContactId(value *int64) {
	m.contact_id = value
}

// SetCreatedBy sets the created_by property value. The created_by property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetCreatedBy(value *int64) {
	m.created_by = value
}

// SetDateCreated sets the date_created property value. The date_created property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetDateCreated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.date_created = value
}

// SetDownloadUrl sets the download_url property value. The download_url property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetDownloadUrl(value *string) {
	m.download_url = value
}

// SetFileName sets the file_name property value. The file_name property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetFileName(value *string) {
	m.file_name = value
}

// SetFileSize sets the file_size property value. The file_size property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetFileSize(value *int64) {
	m.file_size = value
}

// SetId sets the id property value. The id property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetId(value *int64) {
	m.id = value
}

// SetLastUpdated sets the last_updated property value. The last_updated property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetLastUpdated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.last_updated = value
}

// SetPublic sets the public property value. The public property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetPublic(value *bool) {
	m.public = value
}

// SetRemoteFileKey sets the remote_file_key property value. The remote_file_key property
func (m *FilesItemWithFileGetResponse_file_descriptor) SetRemoteFileKey(value *string) {
	m.remote_file_key = value
}

type FilesItemWithFileGetResponse_file_descriptorable interface {
