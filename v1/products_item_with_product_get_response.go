...
type ProductsItemWithProductGetResponse struct {
	// The active property
	active *bool
	...
	subscription_plans []ProductsItemWithProductGetResponse_subscription_plansable
	// The url property
	url *string
}

// NewProductsItemWithProductGetResponse instantiates a new ProductsItemWithProductGetResponse and sets the default values.
func NewProductsItemWithProductGetResponse() *ProductsItemWithProductGetResponse {
	m := &ProductsItemWithProductGetResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateProductsItemWithProductGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateProductsItemWithProductGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewProductsItemWithProductGetResponse(), nil
}

// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *ProductsItemWithProductGetResponse) GetActive() *bool {
	return m.active
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ProductsItemWithProductGetResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ProductsItemWithProductGetResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["subscription_plans"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateProductsItemWithProductGetResponse_subscription_plansFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]ProductsItemWithProductGetResponse_subscription_plansable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(ProductsItemWithProductGetResponse_subscription_plansable)
				}
			}
...
// returns a []ProductsItemWithProductGetResponse_subscription_plansable when successful
func (m *ProductsItemWithProductGetResponse) GetSubscriptionPlans() []ProductsItemWithProductGetResponse_subscription_plansable {
	return m.subscription_plans
}

// GetUrl gets the url property value. The url property
// returns a *string when successful
func (m *ProductsItemWithProductGetResponse) GetUrl() *string {
	return m.url
}

// Serialize serializes information the current object
func (m *ProductsItemWithProductGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ProductsItemWithProductGetResponse) SetActive(value *bool) {
	m.active = value
}

// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ProductsItemWithProductGetResponse) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetId sets the id property value. The id property
func (m *ProductsItemWithProductGetResponse) SetId(value *int64) {
	m.id = value
}

// SetProductDesc sets the product_desc property value. The product_desc property
func (m *ProductsItemWithProductGetResponse) SetProductDesc(value *string) {
	m.product_desc = value
}

// SetProductName sets the product_name property value. The product_name property
func (m *ProductsItemWithProductGetResponse) SetProductName(value *string) {
	m.product_name = value
}

// SetProductPrice sets the product_price property value. The product_price property
func (m *ProductsItemWithProductGetResponse) SetProductPrice(value *float64) {
	m.product_price = value
}

// SetProductShortDesc sets the product_short_desc property value. The product_short_desc property
func (m *ProductsItemWithProductGetResponse) SetProductShortDesc(value *string) {
	m.product_short_desc = value
}

// SetSku sets the sku property value. The sku property
func (m *ProductsItemWithProductGetResponse) SetSku(value *string) {
	m.sku = value
}

// SetSubscriptionOnly sets the subscription_only property value. The subscription_only property
func (m *ProductsItemWithProductGetResponse) SetSubscriptionOnly(value *bool) {
	m.subscription_only = value
}

// SetSubscriptionPlans sets the subscription_plans property value. The subscription_plans property
func (m *ProductsItemWithProductGetResponse) SetSubscriptionPlans(value []ProductsItemWithProductGetResponse_subscription_plansable) {
	m.subscription_plans = value
}

// SetUrl sets the url property value. The url property
func (m *ProductsItemWithProductGetResponse) SetUrl(value *string) {
	m.url = value
}

type ProductsItemWithProductGetResponseable interface {
	...
	GetSubscriptionPlans() []ProductsItemWithProductGetResponse_subscription_plansable
	GetUrl() *string
	...
	SetSubscriptionPlans(value []ProductsItemWithProductGetResponse_subscription_plansable)
	SetUrl(value *string)
}
