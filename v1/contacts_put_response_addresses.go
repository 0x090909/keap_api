...
type ContactsPutResponse_addresses struct {
...
// NewContactsPutResponse_addresses instantiates a new ContactsPutResponse_addresses and sets the default values.
func NewContactsPutResponse_addresses() *ContactsPutResponse_addresses {
	m := &ContactsPutResponse_addresses{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateContactsPutResponse_addressesFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateContactsPutResponse_addressesFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewContactsPutResponse_addresses(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ContactsPutResponse_addresses) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCountryCode gets the country_code property value. The country_code property
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetCountryCode() *string {
	return m.country_code
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ContactsPutResponse_addresses) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetLine1() *string {
	return m.line1
}

// GetLine2 gets the line2 property value. The line2 property
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetLine2() *string {
	return m.line2
}

// GetLocality gets the locality property value. The locality property
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetLocality() *string {
	return m.locality
}
...
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetPostalCode() *string {
	return m.postal_code
}

// GetRegion gets the region property value. The region property
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetRegion() *string {
	return m.region
}
...
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetZipCode() *string {
	return m.zip_code
}
...
// returns a *string when successful
func (m *ContactsPutResponse_addresses) GetZipFour() *string {
	return m.zip_four
}

// Serialize serializes information the current object
func (m *ContactsPutResponse_addresses) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ContactsPutResponse_addresses) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCountryCode sets the country_code property value. The country_code property
func (m *ContactsPutResponse_addresses) SetCountryCode(value *string) {
	m.country_code = value
}

// SetLine1 sets the line1 property value. The line1 property
func (m *ContactsPutResponse_addresses) SetLine1(value *string) {
	m.line1 = value
}

// SetLine2 sets the line2 property value. The line2 property
func (m *ContactsPutResponse_addresses) SetLine2(value *string) {
	m.line2 = value
}

// SetLocality sets the locality property value. The locality property
func (m *ContactsPutResponse_addresses) SetLocality(value *string) {
	m.locality = value
}
...
func (m *ContactsPutResponse_addresses) SetPostalCode(value *string) {
	m.postal_code = value
}

// SetRegion sets the region property value. The region property
func (m *ContactsPutResponse_addresses) SetRegion(value *string) {
	m.region = value
}
...
func (m *ContactsPutResponse_addresses) SetZipCode(value *string) {
	m.zip_code = value
}
...
func (m *ContactsPutResponse_addresses) SetZipFour(value *string) {
	m.zip_four = value
}

type ContactsPutResponse_addressesable interface {
