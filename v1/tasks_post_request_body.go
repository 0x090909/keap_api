...
type TasksPostRequestBody struct {
	...
	contact TasksPostRequestBody_contactable
...
func (m *TasksPostRequestBody) GetCompleted() *bool {
	return m.completed
}

// GetCompletionDate gets the completion_date property value. The completion_date property
// returns a *Time when successful
func (m *TasksPostRequestBody) GetCompletionDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.completion_date
}

// GetContact gets the contact property value. The contact property
// returns a TasksPostRequestBody_contactable when successful
func (m *TasksPostRequestBody) GetContact() TasksPostRequestBody_contactable {
	return m.contact
}

// GetCreationDate gets the creation_date property value. The creation_date property
// returns a *Time when successful
func (m *TasksPostRequestBody) GetCreationDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.creation_date
}

// GetDescription gets the description property value. The description property
// returns a *string when successful
func (m *TasksPostRequestBody) GetDescription() *string {
	return m.description
}

// GetDueDate gets the due_date property value. The due_date property
// returns a *Time when successful
func (m *TasksPostRequestBody) GetDueDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.due_date
}
...
func (m *TasksPostRequestBody) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateTasksPostRequestBody_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(TasksPostRequestBody_contactable))
		}
		return nil
	}
...
func (m *TasksPostRequestBody) GetFunnelId() *int64 {
	return m.funnel_id
}

// GetJgraphId gets the jgraph_id property value. The jgraph_id property
// returns a *int64 when successful
func (m *TasksPostRequestBody) GetJgraphId() *int64 {
	return m.jgraph_id
}

// GetModificationDate gets the modification_date property value. The modification_date property
// returns a *Time when successful
func (m *TasksPostRequestBody) GetModificationDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.modification_date
}

// GetPriority gets the priority property value. The priority property
// returns a *int32 when successful
func (m *TasksPostRequestBody) GetPriority() *int32 {
	return m.priority
}
...
// returns a *int32 when successful
func (m *TasksPostRequestBody) GetRemindTime() *int32 {
	return m.remind_time
}

// GetTitle gets the title property value. The title property
// returns a *string when successful
func (m *TasksPostRequestBody) GetTitle() *string {
	return m.title
}

// GetTypeEscaped gets the type property value. The type property
// returns a *string when successful
func (m *TasksPostRequestBody) GetTypeEscaped() *string {
	return m.typeEscaped
}

// GetUrl gets the url property value. The url property
// returns a *string when successful
func (m *TasksPostRequestBody) GetUrl() *string {
	return m.url
}

// GetUserId gets the user_id property value. The user_id property
// returns a *int64 when successful
func (m *TasksPostRequestBody) GetUserId() *int64 {
	return m.user_id
}
...
func (m *TasksPostRequestBody) SetCompleted(value *bool) {
	m.completed = value
}

// SetCompletionDate sets the completion_date property value. The completion_date property
func (m *TasksPostRequestBody) SetCompletionDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.completion_date = value
}

// SetContact sets the contact property value. The contact property
func (m *TasksPostRequestBody) SetContact(value TasksPostRequestBody_contactable) {
	m.contact = value
}

// SetCreationDate sets the creation_date property value. The creation_date property
func (m *TasksPostRequestBody) SetCreationDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.creation_date = value
}

// SetDescription sets the description property value. The description property
func (m *TasksPostRequestBody) SetDescription(value *string) {
	m.description = value
}

// SetDueDate sets the due_date property value. The due_date property
func (m *TasksPostRequestBody) SetDueDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.due_date = value
}

// SetFunnelId sets the funnel_id property value. The funnel_id property
func (m *TasksPostRequestBody) SetFunnelId(value *int64) {
	m.funnel_id = value
}

// SetJgraphId sets the jgraph_id property value. The jgraph_id property
func (m *TasksPostRequestBody) SetJgraphId(value *int64) {
	m.jgraph_id = value
}

// SetModificationDate sets the modification_date property value. The modification_date property
func (m *TasksPostRequestBody) SetModificationDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.modification_date = value
}

// SetPriority sets the priority property value. The priority property
func (m *TasksPostRequestBody) SetPriority(value *int32) {
	m.priority = value
}
...
func (m *TasksPostRequestBody) SetRemindTime(value *int32) {
	m.remind_time = value
}

// SetTitle sets the title property value. The title property
func (m *TasksPostRequestBody) SetTitle(value *string) {
	m.title = value
}

// SetTypeEscaped sets the type property value. The type property
func (m *TasksPostRequestBody) SetTypeEscaped(value *string) {
	m.typeEscaped = value
}

// SetUrl sets the url property value. The url property
func (m *TasksPostRequestBody) SetUrl(value *string) {
	m.url = value
}

// SetUserId sets the user_id property value. The user_id property
func (m *TasksPostRequestBody) SetUserId(value *int64) {
	m.user_id = value
}
...
type TasksPostRequestBodyable interface {
	...
	GetContact() TasksPostRequestBody_contactable
	...
	SetContact(value TasksPostRequestBody_contactable)
