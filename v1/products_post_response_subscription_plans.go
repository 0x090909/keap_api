...
type ProductsPostResponse_subscription_plans struct {
	// The active property
	active *bool
...
// NewProductsPostResponse_subscription_plans instantiates a new ProductsPostResponse_subscription_plans and sets the default values.
func NewProductsPostResponse_subscription_plans() *ProductsPostResponse_subscription_plans {
	m := &ProductsPostResponse_subscription_plans{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateProductsPostResponse_subscription_plansFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateProductsPostResponse_subscription_plansFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewProductsPostResponse_subscription_plans(), nil
}

// GetActive gets the active property value. The active property
// returns a *bool when successful
func (m *ProductsPostResponse_subscription_plans) GetActive() *bool {
	return m.active
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ProductsPostResponse_subscription_plans) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *ProductsPostResponse_subscription_plans) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
func (m *ProductsPostResponse_subscription_plans) GetFrequency() *int32 {
	return m.frequency
}

// GetId gets the id property value. The id property
// returns a *int64 when successful
func (m *ProductsPostResponse_subscription_plans) GetId() *int64 {
	return m.id
}

// GetNumberOfCycles gets the number_of_cycles property value. The number_of_cycles property
// returns a *int32 when successful
func (m *ProductsPostResponse_subscription_plans) GetNumberOfCycles() *int32 {
	return m.number_of_cycles
}

// GetPlanPrice gets the plan_price property value. The plan_price property
// returns a *float64 when successful
func (m *ProductsPostResponse_subscription_plans) GetPlanPrice() *float64 {
	return m.plan_price
}

// GetSubscriptionPlanIndex gets the subscription_plan_index property value. The subscription_plan_index property
// returns a *int32 when successful
func (m *ProductsPostResponse_subscription_plans) GetSubscriptionPlanIndex() *int32 {
...
func (m *ProductsPostResponse_subscription_plans) GetSubscriptionPlanName() *string {
	return m.subscription_plan_name
}

// GetUrl gets the url property value. The url property
// returns a *string when successful
func (m *ProductsPostResponse_subscription_plans) GetUrl() *string {
	return m.url
}

// Serialize serializes information the current object
func (m *ProductsPostResponse_subscription_plans) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *ProductsPostResponse_subscription_plans) SetActive(value *bool) {
	m.active = value
}

// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *ProductsPostResponse_subscription_plans) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetFrequency sets the frequency property value. The frequency property
func (m *ProductsPostResponse_subscription_plans) SetFrequency(value *int32) {
	m.frequency = value
}

// SetId sets the id property value. The id property
func (m *ProductsPostResponse_subscription_plans) SetId(value *int64) {
	m.id = value
}

// SetNumberOfCycles sets the number_of_cycles property value. The number_of_cycles property
func (m *ProductsPostResponse_subscription_plans) SetNumberOfCycles(value *int32) {
	m.number_of_cycles = value
}

// SetPlanPrice sets the plan_price property value. The plan_price property
func (m *ProductsPostResponse_subscription_plans) SetPlanPrice(value *float64) {
	m.plan_price = value
}

// SetSubscriptionPlanIndex sets the subscription_plan_index property value. The subscription_plan_index property
func (m *ProductsPostResponse_subscription_plans) SetSubscriptionPlanIndex(value *int32) {
...
func (m *ProductsPostResponse_subscription_plans) SetSubscriptionPlanName(value *string) {
	m.subscription_plan_name = value
}

// SetUrl sets the url property value. The url property
func (m *ProductsPostResponse_subscription_plans) SetUrl(value *string) {
	m.url = value
}

type ProductsPostResponse_subscription_plansable interface {
