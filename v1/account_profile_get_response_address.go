...
type AccountProfileGetResponse_address struct {
...
// NewAccountProfileGetResponse_address instantiates a new AccountProfileGetResponse_address and sets the default values.
func NewAccountProfileGetResponse_address() *AccountProfileGetResponse_address {
	m := &AccountProfileGetResponse_address{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateAccountProfileGetResponse_addressFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateAccountProfileGetResponse_addressFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewAccountProfileGetResponse_address(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *AccountProfileGetResponse_address) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCountryCode gets the country_code property value. The country_code property
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetCountryCode() *string {
	return m.country_code
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *AccountProfileGetResponse_address) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetLine1() *string {
	return m.line1
}

// GetLine2 gets the line2 property value. The line2 property
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetLine2() *string {
	return m.line2
}

// GetLocality gets the locality property value. The locality property
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetLocality() *string {
	return m.locality
}
...
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetPostalCode() *string {
	return m.postal_code
}

// GetRegion gets the region property value. The region property
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetRegion() *string {
	return m.region
}
...
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetZipCode() *string {
	return m.zip_code
}
...
// returns a *string when successful
func (m *AccountProfileGetResponse_address) GetZipFour() *string {
	return m.zip_four
}

// Serialize serializes information the current object
func (m *AccountProfileGetResponse_address) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *AccountProfileGetResponse_address) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCountryCode sets the country_code property value. The country_code property
func (m *AccountProfileGetResponse_address) SetCountryCode(value *string) {
	m.country_code = value
}

// SetLine1 sets the line1 property value. The line1 property
func (m *AccountProfileGetResponse_address) SetLine1(value *string) {
	m.line1 = value
}

// SetLine2 sets the line2 property value. The line2 property
func (m *AccountProfileGetResponse_address) SetLine2(value *string) {
	m.line2 = value
}

// SetLocality sets the locality property value. The locality property
func (m *AccountProfileGetResponse_address) SetLocality(value *string) {
	m.locality = value
}
...
func (m *AccountProfileGetResponse_address) SetPostalCode(value *string) {
	m.postal_code = value
}

// SetRegion sets the region property value. The region property
func (m *AccountProfileGetResponse_address) SetRegion(value *string) {
	m.region = value
}
...
func (m *AccountProfileGetResponse_address) SetZipCode(value *string) {
	m.zip_code = value
}
...
func (m *AccountProfileGetResponse_address) SetZipFour(value *string) {
	m.zip_four = value
}

type AccountProfileGetResponse_addressable interface {
