...
type NotesPostResponse struct {
	...
	last_updated_by NotesPostResponse_last_updated_byable
	// The title property
	title *string
...
// NewNotesPostResponse instantiates a new NotesPostResponse and sets the default values.
func NewNotesPostResponse() *NotesPostResponse {
	m := &NotesPostResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateNotesPostResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateNotesPostResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewNotesPostResponse(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *NotesPostResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetBody gets the body property value. The body property
// returns a *string when successful
func (m *NotesPostResponse) GetBody() *string {
	return m.body
}

// GetContactId gets the contact_id property value. The contact_id property
// returns a *int64 when successful
func (m *NotesPostResponse) GetContactId() *int64 {
	return m.contact_id
}

// GetDateCreated gets the date_created property value. The date_created property
// returns a *Time when successful
func (m *NotesPostResponse) GetDateCreated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.date_created
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *NotesPostResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["last_updated_by"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateNotesPostResponse_last_updated_byFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetLastUpdatedBy(val.(NotesPostResponse_last_updated_byable))
		}
		return nil
	}
...
// returns a *int64 when successful
func (m *NotesPostResponse) GetId() *int64 {
	return m.id
}

// GetLastUpdated gets the last_updated property value. The last_updated property
// returns a *Time when successful
func (m *NotesPostResponse) GetLastUpdated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.last_updated
}

// GetLastUpdatedBy gets the last_updated_by property value. The last_updated_by property
// returns a NotesPostResponse_last_updated_byable when successful
func (m *NotesPostResponse) GetLastUpdatedBy() NotesPostResponse_last_updated_byable {
	return m.last_updated_by
}

// GetTitle gets the title property value. The title property
// returns a *string when successful
func (m *NotesPostResponse) GetTitle() *string {
	return m.title
}

// GetUserId gets the user_id property value. The user_id property
// returns a *int64 when successful
func (m *NotesPostResponse) GetUserId() *int64 {
	return m.user_id
}

// Serialize serializes information the current object
func (m *NotesPostResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *NotesPostResponse) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetBody sets the body property value. The body property
func (m *NotesPostResponse) SetBody(value *string) {
	m.body = value
}

// SetContactId sets the contact_id property value. The contact_id property
func (m *NotesPostResponse) SetContactId(value *int64) {
	m.contact_id = value
}

// SetDateCreated sets the date_created property value. The date_created property
func (m *NotesPostResponse) SetDateCreated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.date_created = value
}

// SetId sets the id property value. The id property
func (m *NotesPostResponse) SetId(value *int64) {
	m.id = value
}

// SetLastUpdated sets the last_updated property value. The last_updated property
func (m *NotesPostResponse) SetLastUpdated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.last_updated = value
}

// SetLastUpdatedBy sets the last_updated_by property value. The last_updated_by property
func (m *NotesPostResponse) SetLastUpdatedBy(value NotesPostResponse_last_updated_byable) {
	m.last_updated_by = value
}

// SetTitle sets the title property value. The title property
func (m *NotesPostResponse) SetTitle(value *string) {
	m.title = value
}

// SetUserId sets the user_id property value. The user_id property
func (m *NotesPostResponse) SetUserId(value *int64) {
	m.user_id = value
}

type NotesPostResponseable interface {
	...
	GetLastUpdatedBy() NotesPostResponse_last_updated_byable
	GetTitle() *string
	GetUserId() *int64
	...
	SetLastUpdatedBy(value NotesPostResponse_last_updated_byable)
