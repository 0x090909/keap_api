...
type OrdersItemPaymentPlanPutRequestBody struct {
	...
	payment_gateway OrdersItemPaymentPlanPutRequestBody_payment_gatewayable
	// The plan_start_date property
	plan_start_date *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly
}

// NewOrdersItemPaymentPlanPutRequestBody instantiates a new OrdersItemPaymentPlanPutRequestBody and sets the default values.
func NewOrdersItemPaymentPlanPutRequestBody() *OrdersItemPaymentPlanPutRequestBody {
	m := &OrdersItemPaymentPlanPutRequestBody{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOrdersItemPaymentPlanPutRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOrdersItemPaymentPlanPutRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOrdersItemPaymentPlanPutRequestBody(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OrdersItemPaymentPlanPutRequestBody) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAutoCharge gets the auto_charge property value. The auto_charge property
// returns a *bool when successful
func (m *OrdersItemPaymentPlanPutRequestBody) GetAutoCharge() *bool {
	return m.auto_charge
}

// GetCreditCardId gets the credit_card_id property value. The credit_card_id property
// returns a *int64 when successful
func (m *OrdersItemPaymentPlanPutRequestBody) GetCreditCardId() *int64 {
...
func (m *OrdersItemPaymentPlanPutRequestBody) GetDaysBetweenPayments() *int32 {
	return m.days_between_payments
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OrdersItemPaymentPlanPutRequestBody) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["payment_gateway"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOrdersItemPaymentPlanPutRequestBody_payment_gatewayFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetPaymentGateway(val.(OrdersItemPaymentPlanPutRequestBody_payment_gatewayable))
		}
		return nil
	}
...
func (m *OrdersItemPaymentPlanPutRequestBody) GetInitialPaymentAmount() *float64 {
...
func (m *OrdersItemPaymentPlanPutRequestBody) GetInitialPaymentDate() *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly {
...
// returns a *int32 when successful
func (m *OrdersItemPaymentPlanPutRequestBody) GetNumberOfPayments() *int32 {
	return m.number_of_payments
}

// GetPaymentGateway gets the payment_gateway property value. The payment_gateway property
// returns a OrdersItemPaymentPlanPutRequestBody_payment_gatewayable when successful
func (m *OrdersItemPaymentPlanPutRequestBody) GetPaymentGateway() OrdersItemPaymentPlanPutRequestBody_payment_gatewayable {
	return m.payment_gateway
}

// GetPlanStartDate gets the plan_start_date property value. The plan_start_date property
// returns a *DateOnly when successful
func (m *OrdersItemPaymentPlanPutRequestBody) GetPlanStartDate() *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly {
	return m.plan_start_date
}

// Serialize serializes information the current object
func (m *OrdersItemPaymentPlanPutRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *OrdersItemPaymentPlanPutRequestBody) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetAutoCharge sets the auto_charge property value. The auto_charge property
func (m *OrdersItemPaymentPlanPutRequestBody) SetAutoCharge(value *bool) {
	m.auto_charge = value
}

// SetCreditCardId sets the credit_card_id property value. The credit_card_id property
func (m *OrdersItemPaymentPlanPutRequestBody) SetCreditCardId(value *int64) {
...
func (m *OrdersItemPaymentPlanPutRequestBody) SetDaysBetweenPayments(value *int32) {
...
func (m *OrdersItemPaymentPlanPutRequestBody) SetInitialPaymentAmount(value *float64) {
...
func (m *OrdersItemPaymentPlanPutRequestBody) SetInitialPaymentDate(value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly) {
...
func (m *OrdersItemPaymentPlanPutRequestBody) SetNumberOfPayments(value *int32) {
	m.number_of_payments = value
}

// SetPaymentGateway sets the payment_gateway property value. The payment_gateway property
func (m *OrdersItemPaymentPlanPutRequestBody) SetPaymentGateway(value OrdersItemPaymentPlanPutRequestBody_payment_gatewayable) {
	m.payment_gateway = value
}

// SetPlanStartDate sets the plan_start_date property value. The plan_start_date property
func (m *OrdersItemPaymentPlanPutRequestBody) SetPlanStartDate(value *i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.DateOnly) {
	m.plan_start_date = value
}

type OrdersItemPaymentPlanPutRequestBodyable interface {
	...
	GetPaymentGateway() OrdersItemPaymentPlanPutRequestBody_payment_gatewayable
	...
	SetPaymentGateway(value OrdersItemPaymentPlanPutRequestBody_payment_gatewayable)
