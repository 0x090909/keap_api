...
func (m *CampaignsGetResponse_campaigns_goals) GetId() *int64 {
	return m.id
}
...
// returns a []int64 when successful
func (m *CampaignsGetResponse_campaigns_goals) GetNextSequenceIds() []int64 {
...
// returns a []int64 when successful
func (m *CampaignsGetResponse_campaigns_goals) GetPreviousSequenceIds() []int64 {
...
func (m *CampaignsGetResponse_campaigns_goals) SetId(value *int64) {
	m.id = value
}
...
func (m *CampaignsGetResponse_campaigns_goals) SetNextSequenceIds(value []int64) {
...
func (m *CampaignsGetResponse_campaigns_goals) SetPreviousSequenceIds(value []int64) {
