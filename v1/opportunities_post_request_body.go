...
type OpportunitiesPostRequestBody struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// The affiliate_id property
	affiliate_id *int64
	// The contact property
	contact OpportunitiesPostRequestBody_contactable
	// The custom_fields property
	custom_fields []OpportunitiesPostRequestBody_custom_fieldsable
	...
	// The stage property
	stage OpportunitiesPostRequestBody_stageable
	// The user property
	user OpportunitiesPostRequestBody_userable
}

// NewOpportunitiesPostRequestBody instantiates a new OpportunitiesPostRequestBody and sets the default values.
func NewOpportunitiesPostRequestBody() *OpportunitiesPostRequestBody {
	m := &OpportunitiesPostRequestBody{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOpportunitiesPostRequestBodyFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOpportunitiesPostRequestBodyFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOpportunitiesPostRequestBody(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OpportunitiesPostRequestBody) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAffiliateId gets the affiliate_id property value. The affiliate_id property
// returns a *int64 when successful
func (m *OpportunitiesPostRequestBody) GetAffiliateId() *int64 {
	return m.affiliate_id
}

// GetContact gets the contact property value. The contact property
// returns a OpportunitiesPostRequestBody_contactable when successful
func (m *OpportunitiesPostRequestBody) GetContact() OpportunitiesPostRequestBody_contactable {
	return m.contact
}

// GetCustomFields gets the custom_fields property value. The custom_fields property
// returns a []OpportunitiesPostRequestBody_custom_fieldsable when successful
func (m *OpportunitiesPostRequestBody) GetCustomFields() []OpportunitiesPostRequestBody_custom_fieldsable {
	return m.custom_fields
}

// GetDateCreated gets the date_created property value. The date_created property
// returns a *Time when successful
func (m *OpportunitiesPostRequestBody) GetDateCreated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
func (m *OpportunitiesPostRequestBody) GetEstimatedCloseDate() *string {
	return m.estimated_close_date
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OpportunitiesPostRequestBody) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesPostRequestBody_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(OpportunitiesPostRequestBody_contactable))
		}
		return nil
	}
	res["custom_fields"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateOpportunitiesPostRequestBody_custom_fieldsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]OpportunitiesPostRequestBody_custom_fieldsable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(OpportunitiesPostRequestBody_custom_fieldsable)
				}
			}
	...
	res["stage"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesPostRequestBody_stageFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetStage(val.(OpportunitiesPostRequestBody_stageable))
		}
		return nil
	}
	res["user"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesPostRequestBody_userFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetUser(val.(OpportunitiesPostRequestBody_userable))
		}
		return nil
	}
	return res
...
func (m *OpportunitiesPostRequestBody) GetProjectedRevenueHigh() *float64 {
...
// returns a *float64 when successful
func (m *OpportunitiesPostRequestBody) GetProjectedRevenueLow() *float64 {
	return m.projected_revenue_low
}

// GetStage gets the stage property value. The stage property
// returns a OpportunitiesPostRequestBody_stageable when successful
func (m *OpportunitiesPostRequestBody) GetStage() OpportunitiesPostRequestBody_stageable {
	return m.stage
}

// GetUser gets the user property value. The user property
// returns a OpportunitiesPostRequestBody_userable when successful
func (m *OpportunitiesPostRequestBody) GetUser() OpportunitiesPostRequestBody_userable {
	return m.user
}

// Serialize serializes information the current object
func (m *OpportunitiesPostRequestBody) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
	...
	{
		err := writer.WriteStringValue("estimated_close_date", m.GetEstimatedCloseDate())
		if err != nil {
			return err
		}
	}
	...
	{
		err := writer.WriteStringValue("next_action_date", m.GetNextActionDate())
		if err != nil {
			return err
		}
	}
...
func (m *OpportunitiesPostRequestBody) SetProjectedRevenueHigh(value *float64) {
...
func (m *OpportunitiesPostRequestBody) SetProjectedRevenueLow(value *float64) {
	m.projected_revenue_low = value
}

// SetStage sets the stage property value. The stage property
func (m *OpportunitiesPostRequestBody) SetStage(value OpportunitiesPostRequestBody_stageable) {
	m.stage = value
}

// SetUser sets the user property value. The user property
func (m *OpportunitiesPostRequestBody) SetUser(value OpportunitiesPostRequestBody_userable) {
	m.user = value
}

type OpportunitiesPostRequestBodyable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAffiliateId() *int64
	GetContact() OpportunitiesPostRequestBody_contactable
	GetCustomFields() []OpportunitiesPostRequestBody_custom_fieldsable
	GetDateCreated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time
	GetEstimatedCloseDate() *string
	GetId() *int64
	GetIncludeInForecast() *int32
	GetLastUpdated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time
	GetNextActionDate() *string
	...
	GetStage() OpportunitiesPostRequestBody_stageable
	GetUser() OpportunitiesPostRequestBody_userable
	SetAffiliateId(value *int64)
	SetContact(value OpportunitiesPostRequestBody_contactable)
	SetCustomFields(value []OpportunitiesPostRequestBody_custom_fieldsable)
	SetDateCreated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
	SetEstimatedCloseDate(value *string)
	SetId(value *int64)
	...
	SetNextActionDate(value *string)
	...
	SetStage(value OpportunitiesPostRequestBody_stageable)
	SetUser(value OpportunitiesPostRequestBody_userable)
}
