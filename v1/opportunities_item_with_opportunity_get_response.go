...
type OpportunitiesItemWithOpportunityGetResponse struct {
	// Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
	additionalData map[string]any
	// The affiliate_id property
	affiliate_id *int64
	// The contact property
	contact OpportunitiesItemWithOpportunityGetResponse_contactable
	// The custom_fields property
	custom_fields []OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable
	...
	// The stage property
	stage OpportunitiesItemWithOpportunityGetResponse_stageable
	// The user property
	user OpportunitiesItemWithOpportunityGetResponse_userable
}

// NewOpportunitiesItemWithOpportunityGetResponse instantiates a new OpportunitiesItemWithOpportunityGetResponse and sets the default values.
func NewOpportunitiesItemWithOpportunityGetResponse() *OpportunitiesItemWithOpportunityGetResponse {
	m := &OpportunitiesItemWithOpportunityGetResponse{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateOpportunitiesItemWithOpportunityGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateOpportunitiesItemWithOpportunityGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewOpportunitiesItemWithOpportunityGetResponse(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetAffiliateId gets the affiliate_id property value. The affiliate_id property
// returns a *int64 when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetAffiliateId() *int64 {
	return m.affiliate_id
}

// GetContact gets the contact property value. The contact property
// returns a OpportunitiesItemWithOpportunityGetResponse_contactable when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetContact() OpportunitiesItemWithOpportunityGetResponse_contactable {
	return m.contact
}

// GetCustomFields gets the custom_fields property value. The custom_fields property
// returns a []OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetCustomFields() []OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable {
	return m.custom_fields
}

// GetDateCreated gets the date_created property value. The date_created property
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetDateCreated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetEstimatedCloseDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.estimated_close_date
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["contact"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesItemWithOpportunityGetResponse_contactFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetContact(val.(OpportunitiesItemWithOpportunityGetResponse_contactable))
		}
		return nil
	}
	res["custom_fields"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateOpportunitiesItemWithOpportunityGetResponse_custom_fieldsFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable)
				}
			}
	...
	res["stage"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesItemWithOpportunityGetResponse_stageFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetStage(val.(OpportunitiesItemWithOpportunityGetResponse_stageable))
		}
		return nil
	}
	res["user"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetObjectValue(CreateOpportunitiesItemWithOpportunityGetResponse_userFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			m.SetUser(val.(OpportunitiesItemWithOpportunityGetResponse_userable))
		}
		return nil
	}
	return res
...
// returns a *int64 when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetId() *int64 {
	return m.id
}

// GetIncludeInForecast gets the include_in_forecast property value. The include_in_forecast property
// returns a *int32 when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetIncludeInForecast() *int32 {
	return m.include_in_forecast
}

// GetLastUpdated gets the last_updated property value. The last_updated property
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetLastUpdated() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
	return m.last_updated
}

// GetNextActionDate gets the next_action_date property value. The next_action_date property
// returns a *Time when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetNextActionDate() *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time {
...
func (m *OpportunitiesItemWithOpportunityGetResponse) GetProjectedRevenueHigh() *float64 {
...
// returns a *float64 when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetProjectedRevenueLow() *float64 {
	return m.projected_revenue_low
}

// GetStage gets the stage property value. The stage property
// returns a OpportunitiesItemWithOpportunityGetResponse_stageable when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetStage() OpportunitiesItemWithOpportunityGetResponse_stageable {
	return m.stage
}

// GetUser gets the user property value. The user property
// returns a OpportunitiesItemWithOpportunityGetResponse_userable when successful
func (m *OpportunitiesItemWithOpportunityGetResponse) GetUser() OpportunitiesItemWithOpportunityGetResponse_userable {
	return m.user
}

// Serialize serializes information the current object
func (m *OpportunitiesItemWithOpportunityGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *OpportunitiesItemWithOpportunityGetResponse) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetAffiliateId sets the affiliate_id property value. The affiliate_id property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetAffiliateId(value *int64) {
	m.affiliate_id = value
}

// SetContact sets the contact property value. The contact property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetContact(value OpportunitiesItemWithOpportunityGetResponse_contactable) {
	m.contact = value
}

// SetCustomFields sets the custom_fields property value. The custom_fields property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetCustomFields(value []OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable) {
	m.custom_fields = value
}

// SetDateCreated sets the date_created property value. The date_created property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetDateCreated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.date_created = value
}

// SetEstimatedCloseDate sets the estimated_close_date property value. The estimated_close_date property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetEstimatedCloseDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.estimated_close_date = value
}

// SetId sets the id property value. The id property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetId(value *int64) {
	m.id = value
}

// SetIncludeInForecast sets the include_in_forecast property value. The include_in_forecast property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetIncludeInForecast(value *int32) {
	m.include_in_forecast = value
}

// SetLastUpdated sets the last_updated property value. The last_updated property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetLastUpdated(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.last_updated = value
}

// SetNextActionDate sets the next_action_date property value. The next_action_date property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetNextActionDate(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
	m.next_action_date = value
}

// SetNextActionNotes sets the next_action_notes property value. The next_action_notes property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetNextActionNotes(value *string) {
	m.next_action_notes = value
}

// SetOpportunityNotes sets the opportunity_notes property value. The opportunity_notes property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetOpportunityNotes(value *string) {
	m.opportunity_notes = value
}

// SetOpportunityTitle sets the opportunity_title property value. The opportunity_title property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetOpportunityTitle(value *string) {
...
func (m *OpportunitiesItemWithOpportunityGetResponse) SetProjectedRevenueHigh(value *float64) {
...
func (m *OpportunitiesItemWithOpportunityGetResponse) SetProjectedRevenueLow(value *float64) {
	m.projected_revenue_low = value
}

// SetStage sets the stage property value. The stage property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetStage(value OpportunitiesItemWithOpportunityGetResponse_stageable) {
	m.stage = value
}

// SetUser sets the user property value. The user property
func (m *OpportunitiesItemWithOpportunityGetResponse) SetUser(value OpportunitiesItemWithOpportunityGetResponse_userable) {
	m.user = value
}

type OpportunitiesItemWithOpportunityGetResponseable interface {
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
	i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
	GetAffiliateId() *int64
	GetContact() OpportunitiesItemWithOpportunityGetResponse_contactable
	GetCustomFields() []OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable
	...
	GetStage() OpportunitiesItemWithOpportunityGetResponse_stageable
	GetUser() OpportunitiesItemWithOpportunityGetResponse_userable
	SetAffiliateId(value *int64)
	SetContact(value OpportunitiesItemWithOpportunityGetResponse_contactable)
	SetCustomFields(value []OpportunitiesItemWithOpportunityGetResponse_custom_fieldsable)
	...
	SetStage(value OpportunitiesItemWithOpportunityGetResponse_stageable)
	SetUser(value OpportunitiesItemWithOpportunityGetResponse_userable)
}
