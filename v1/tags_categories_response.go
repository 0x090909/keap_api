...
// Deprecated: This class is obsolete. Use TagsCategoriesPostResponseable instead.
type TagsCategoriesResponse struct {
	TagsCategoriesPostResponse
}
...
func NewTagsCategoriesResponse() *TagsCategoriesResponse {
	m := &TagsCategoriesResponse{
		TagsCategoriesPostResponse: *NewTagsCategoriesPostResponse(),
	}
	return m
}
...
type TagsCategoriesResponseable interface {
	...
	TagsCategoriesPostResponseable
}
