...
type Affiliates401Error_cause struct {
	...
	stackTrace []Affiliates401Error_cause_stackTraceable
	// The suppressed property
	suppressed []ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable
}

// NewAffiliates401Error_cause instantiates a new Affiliates401Error_cause and sets the default values.
func NewAffiliates401Error_cause() *Affiliates401Error_cause {
	m := &Affiliates401Error_cause{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateAffiliates401Error_causeFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateAffiliates401Error_causeFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewAffiliates401Error_cause(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *Affiliates401Error_cause) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCause gets the cause property value. The cause property
// returns a Throwableable when successful
func (m *Affiliates401Error_cause) GetCause() ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable {
	return m.cause
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *Affiliates401Error_cause) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
	...
	res["stackTrace"] = func(n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
		val, err := n.GetCollectionOfObjectValues(CreateAffiliates401Error_cause_stackTraceFromDiscriminatorValue)
		if err != nil {
			return err
		}
		if val != nil {
			res := make([]Affiliates401Error_cause_stackTraceable, len(val))
			for i, v := range val {
				if v != nil {
					res[i] = v.(Affiliates401Error_cause_stackTraceable)
				}
			}
			m.SetStackTrace(res)
		}
...
func (m *Affiliates401Error_cause) GetLocalizedMessage() *string {
	return m.localizedMessage
}

// GetMessage gets the message property value. The message property
// returns a *string when successful
func (m *Affiliates401Error_cause) GetMessage() *string {
	return m.message
}

// GetStackTrace gets the stackTrace property value. The stackTrace property
// returns a []Affiliates401Error_cause_stackTraceable when successful
func (m *Affiliates401Error_cause) GetStackTrace() []Affiliates401Error_cause_stackTraceable {
	return m.stackTrace
}

// GetSuppressed gets the suppressed property value. The suppressed property
// returns a []Throwableable when successful
func (m *Affiliates401Error_cause) GetSuppressed() []ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable {
	return m.suppressed
}

// Serialize serializes information the current object
func (m *Affiliates401Error_cause) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *Affiliates401Error_cause) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCause sets the cause property value. The cause property
func (m *Affiliates401Error_cause) SetCause(value ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable) {
	m.cause = value
}

// SetLocalizedMessage sets the localizedMessage property value. The localizedMessage property
func (m *Affiliates401Error_cause) SetLocalizedMessage(value *string) {
	m.localizedMessage = value
}

// SetMessage sets the message property value. The message property
func (m *Affiliates401Error_cause) SetMessage(value *string) {
	m.message = value
}

// SetStackTrace sets the stackTrace property value. The stackTrace property
func (m *Affiliates401Error_cause) SetStackTrace(value []Affiliates401Error_cause_stackTraceable) {
	m.stackTrace = value
}

// SetSuppressed sets the suppressed property value. The suppressed property
func (m *Affiliates401Error_cause) SetSuppressed(value []ic811111da47f7c5d6f6d121f0e78585ed7060c3db2cbfa4a5d929d3a72d517ff.Throwableable) {
	m.suppressed = value
}

type Affiliates401Error_causeable interface {
	...
	GetMessage() *string
	GetStackTrace() []Affiliates401Error_cause_stackTraceable
	...
	SetStackTrace(value []Affiliates401Error_cause_stackTraceable)
