...
type SettingApplicationConfigurationGetResponse_ecommerce struct {
...
// NewSettingApplicationConfigurationGetResponse_ecommerce instantiates a new SettingApplicationConfigurationGetResponse_ecommerce and sets the default values.
func NewSettingApplicationConfigurationGetResponse_ecommerce() *SettingApplicationConfigurationGetResponse_ecommerce {
	m := &SettingApplicationConfigurationGetResponse_ecommerce{}
	m.SetAdditionalData(make(map[string]any))
	return m
}

// CreateSettingApplicationConfigurationGetResponse_ecommerceFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateSettingApplicationConfigurationGetResponse_ecommerceFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) (i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
	return NewSettingApplicationConfigurationGetResponse_ecommerce(), nil
}

// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetAdditionalData() map[string]any {
	return m.additionalData
}

// GetCreditCardTypes gets the credit_card_types property value. The credit_card_types property
// returns a *string when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetCreditCardTypes() *string {
	return m.credit_card_types
}

// GetCurrency gets the currency property value. The currency property
// returns a *string when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetCurrency() *string {
	return m.currency
}
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetDefaultChargeMaxRetryAttempts() *int32 {
...
// returns a *string when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetDefaultCountry() *string {
	return m.default_country
}

// GetDefaultMerchant gets the default_merchant property value. The default_merchant property
// returns a *string when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetDefaultMerchant() *string {
...
// returns a *int32 when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetDefaultNumberOfDaysBetweenChargeAttempts() *int32 {
...
// returns a *string when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetDefaultTax() *string {
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetDefaultToAutoCharge() *bool {
	return m.default_to_auto_charge
}

// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetFieldDeserializers() map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
...
// returns a *int32 when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetMerchantAccountMaxRetryAttempts() *int32 {
...
// returns a *string when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetPaymentTypes() *string {
	return m.payment_types
}

// GetPromoCodes gets the promo_codes property value. The promo_codes property
// returns a *string when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetPromoCodes() *string {
	return m.promo_codes
}

// GetTrackCostPerUnit gets the track_cost_per_unit property value. The track_cost_per_unit property
// returns a *bool when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetTrackCostPerUnit() *bool {
	return m.track_cost_per_unit
}

// GetTrackInventory gets the track_inventory property value. The track_inventory property
// returns a *bool when successful
func (m *SettingApplicationConfigurationGetResponse_ecommerce) GetTrackInventory() *bool {
	return m.track_inventory
}

// Serialize serializes information the current object
func (m *SettingApplicationConfigurationGetResponse_ecommerce) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter) error {
	{
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetAdditionalData(value map[string]any) {
	m.additionalData = value
}

// SetCreditCardTypes sets the credit_card_types property value. The credit_card_types property
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetCreditCardTypes(value *string) {
	m.credit_card_types = value
}

// SetCurrency sets the currency property value. The currency property
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetCurrency(value *string) {
	m.currency = value
}
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetDefaultChargeMaxRetryAttempts(value *int32) {
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetDefaultCountry(value *string) {
	m.default_country = value
}

// SetDefaultMerchant sets the default_merchant property value. The default_merchant property
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetDefaultMerchant(value *string) {
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetDefaultNumberOfDaysBetweenChargeAttempts(value *int32) {
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetDefaultTax(value *string) {
	m.default_tax = value
}

// SetDefaultToAutoCharge sets the default_to_auto_charge property value. The default_to_auto_charge property
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetDefaultToAutoCharge(value *bool) {
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetMerchantAccountMaxRetryAttempts(value *int32) {
...
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetPaymentTypes(value *string) {
	m.payment_types = value
}

// SetPromoCodes sets the promo_codes property value. The promo_codes property
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetPromoCodes(value *string) {
	m.promo_codes = value
}

// SetTrackCostPerUnit sets the track_cost_per_unit property value. The track_cost_per_unit property
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetTrackCostPerUnit(value *bool) {
	m.track_cost_per_unit = value
}

// SetTrackInventory sets the track_inventory property value. The track_inventory property
func (m *SettingApplicationConfigurationGetResponse_ecommerce) SetTrackInventory(value *bool) {
	m.track_inventory = value
}

type SettingApplicationConfigurationGetResponse_ecommerceable interface {
